...
impl HRESULT {
    ...
    pub fn message(&self) -> HSTRING {
        ...
        unsafe {
            let size = crate::imp::FormatMessageW(crate::imp::FORMAT_MESSAGE_ALLOCATE_BUFFER | crate::imp::FORMAT_MESSAGE_FROM_SYSTEM | crate::imp::FORMAT_MESSAGE_IGNORE_INSERTS, std::ptr::null(), self.0 as u32, 0, <*mut crate::imp::PWSTR>::cast(&mut message.0), 0, std::ptr::null());

            HSTRING::from_wide(crate::imp::wide_trim_end(std::slice::from_raw_parts(message.0 as crate::imp::PCWSTR, size as usize))).unwrap_or_default()
        }
    }
