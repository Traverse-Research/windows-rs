...
pub trait IProofOfPossessionCookieInfoManager4_Impl: windows_core::IUnknownImpl {
    ...
    fn GetCookieInfoWithUriAndUserAgentIdForAccount(&self, webaccount: windows_core::Ref<'_, windows_core::IInspectable>, uri: &windows_core::PCWSTR, uaclientid: &windows_core::PCWSTR, cookieinfocount: *mut u32, cookieinfo: *mut *mut ProofOfPossessionCookieInfo) -> windows_core::Result<()>;
}
