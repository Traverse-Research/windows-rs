...
pub unsafe fn CloseConsoleHandle(hconsole: super::super::Foundation::HANDLE) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn CloseConsoleHandle(hconsole : super::super::Foundation:: HANDLE) -> windows_core::BOOL);
...
pub unsafe fn DuplicateConsoleHandle(hsourcehandle: super::super::Foundation::HANDLE, dwdesiredaccess: u32, binherithandle: bool, dwoptions: u32) -> super::super::Foundation::HANDLE {
    windows_link::link!("kernel32.dll" "system" fn DuplicateConsoleHandle(hsourcehandle : super::super::Foundation:: HANDLE, dwdesiredaccess : u32, binherithandle : windows_core::BOOL, dwoptions : u32) -> super::super::Foundation:: HANDLE);
...
pub unsafe fn GetConsoleCharType(hconsole: super::super::Foundation::HANDLE, coordcheck: COORD, pdwtype: *mut u32) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn GetConsoleCharType(hconsole : super::super::Foundation:: HANDLE, coordcheck : COORD, pdwtype : *mut u32) -> windows_core::BOOL);
...
pub unsafe fn GetConsoleCursorMode(hconsolehandle: super::super::Foundation::HANDLE, pbblink: *mut windows_core::BOOL, pbdbenable: *mut windows_core::BOOL) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn GetConsoleCursorMode(hconsolehandle : super::super::Foundation:: HANDLE, pbblink : *mut windows_core::BOOL, pbdbenable : *mut windows_core::BOOL) -> windows_core::BOOL);
...
pub unsafe fn GetConsoleFontInfo(hconsoleoutput: super::super::Foundation::HANDLE, bmaximumwindow: bool, nlength: u32, lpconsolefontinfo: *mut CONSOLE_FONT_INFO) -> u32 {
    windows_link::link!("kernel32.dll" "system" fn GetConsoleFontInfo(hconsoleoutput : super::super::Foundation:: HANDLE, bmaximumwindow : windows_core::BOOL, nlength : u32, lpconsolefontinfo : *mut CONSOLE_FONT_INFO) -> u32);
...
pub unsafe fn GetConsoleHardwareState(hconsoleoutput: super::super::Foundation::HANDLE, lpresolution: *mut COORD, lpfontsize: *mut COORD) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn GetConsoleHardwareState(hconsoleoutput : super::super::Foundation:: HANDLE, lpresolution : *mut COORD, lpfontsize : *mut COORD) -> windows_core::BOOL);
...
pub unsafe fn GetConsoleInputExeNameA(lpbuffer: &mut [u8]) -> u32 {
    windows_link::link!("kernel32.dll" "system" fn GetConsoleInputExeNameA(nbufferlength : u32, lpbuffer : windows_core::PSTR) -> u32);
...
pub unsafe fn GetConsoleInputExeNameW(lpbuffer: &mut [u16]) -> u32 {
    windows_link::link!("kernel32.dll" "system" fn GetConsoleInputExeNameW(nbufferlength : u32, lpbuffer : windows_core::PWSTR) -> u32);
...
pub unsafe fn GetConsoleKeyboardLayoutNameA(pszlayout: &mut [u8; 9]) -> windows_core::BOOL {
    windows_link::link!("user32.dll" "system" fn GetConsoleKeyboardLayoutNameA(pszlayout : windows_core::PSTR) -> windows_core::BOOL);
...
pub unsafe fn GetConsoleKeyboardLayoutNameW(pszlayout: &mut [u16; 9]) -> windows_core::BOOL {
    windows_link::link!("user32.dll" "system" fn GetConsoleKeyboardLayoutNameW(pszlayout : windows_core::PWSTR) -> windows_core::BOOL);
...
pub unsafe fn GetConsoleNlsMode(hconsole: super::super::Foundation::HANDLE, lpdwnlsmode: *mut u32) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn GetConsoleNlsMode(hconsole : super::super::Foundation:: HANDLE, lpdwnlsmode : *mut u32) -> windows_core::BOOL);
...
pub unsafe fn InvalidateConsoleDIBits(hconsoleoutput: super::super::Foundation::HANDLE, lprect: *const SMALL_RECT) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn InvalidateConsoleDIBits(hconsoleoutput : super::super::Foundation:: HANDLE, lprect : *const SMALL_RECT) -> windows_core::BOOL);
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn OpenConsoleW(lpconsoledevice : windows_core::PCWSTR, dwdesiredaccess : u32, binherithandle : windows_core::BOOL, dwsharemode : u32) -> super::super::Foundation:: HANDLE);
...
pub unsafe fn ReadConsoleInputExA(hconsoleinput: super::super::Foundation::HANDLE, lpbuffer: &mut [INPUT_RECORD], lpnumberofeventsread: *mut u32, wflags: u16) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn ReadConsoleInputExA(hconsoleinput : super::super::Foundation:: HANDLE, lpbuffer : *mut INPUT_RECORD, nlength : u32, lpnumberofeventsread : *mut u32, wflags : u16) -> windows_core::BOOL);
...
pub unsafe fn ReadConsoleInputExW(hconsoleinput: super::super::Foundation::HANDLE, lpbuffer: &mut [INPUT_RECORD], lpnumberofeventsread: *mut u32, wflags: u16) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn ReadConsoleInputExW(hconsoleinput : super::super::Foundation:: HANDLE, lpbuffer : *mut INPUT_RECORD, nlength : u32, lpnumberofeventsread : *mut u32, wflags : u16) -> windows_core::BOOL);
...
pub unsafe fn RegisterConsoleIME(hwndconsoleime: super::super::Foundation::HWND, lpdwconsolethreadid: Option<*mut u32>) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn RegisterConsoleIME(hwndconsoleime : super::super::Foundation:: HWND, lpdwconsolethreadid : *mut u32) -> windows_core::BOOL);
...
pub unsafe fn RegisterConsoleOS2(fos2register: bool) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn RegisterConsoleOS2(fos2register : windows_core::BOOL) -> windows_core::BOOL);
...
pub unsafe fn SetConsoleCursor(hconsoleoutput: super::super::Foundation::HANDLE, hcursor: super::super::UI::WindowsAndMessaging::HCURSOR) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn SetConsoleCursor(hconsoleoutput : super::super::Foundation:: HANDLE, hcursor : super::super::UI::WindowsAndMessaging:: HCURSOR) -> windows_core::BOOL);
...
pub unsafe fn SetConsoleCursorMode(hconsolehandle: super::super::Foundation::HANDLE, blink: bool, dbenable: bool) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn SetConsoleCursorMode(hconsolehandle : super::super::Foundation:: HANDLE, blink : windows_core::BOOL, dbenable : windows_core::BOOL) -> windows_core::BOOL);
...
pub unsafe fn SetConsoleFont(hconsoleoutput: super::super::Foundation::HANDLE, nfont: u32) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn SetConsoleFont(hconsoleoutput : super::super::Foundation:: HANDLE, nfont : u32) -> windows_core::BOOL);
...
pub unsafe fn SetConsoleHardwareState(hconsoleoutput: super::super::Foundation::HANDLE, dwresolution: COORD, dwfontsize: COORD) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn SetConsoleHardwareState(hconsoleoutput : super::super::Foundation:: HANDLE, dwresolution : COORD, dwfontsize : COORD) -> windows_core::BOOL);
...
pub unsafe fn SetConsoleIcon(hicon: super::super::UI::WindowsAndMessaging::HICON) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn SetConsoleIcon(hicon : super::super::UI::WindowsAndMessaging:: HICON) -> windows_core::BOOL);
...
where
    P0: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn SetConsoleInputExeNameA(lpexename : windows_core::PCSTR) -> windows_core::BOOL);
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn SetConsoleInputExeNameW(lpexename : windows_core::PCWSTR) -> windows_core::BOOL);
...
pub unsafe fn SetConsoleKeyShortcuts(bset: bool, breservekeys: u8, lpappkeys: &[APPKEY]) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn SetConsoleKeyShortcuts(bset : windows_core::BOOL, breservekeys : u8, lpappkeys : *const APPKEY, dwnumappkeys : u32) -> windows_core::BOOL);
...
where
    P3: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("kernel32.dll" "system" fn SetConsoleLocalEUDC(hconsolehandle : super::super::Foundation:: HANDLE, wcodepoint : u16, cfontsize : COORD, lpsb : windows_core::PCSTR) -> windows_core::BOOL);
...
pub unsafe fn SetConsoleMenuClose(benable: bool) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn SetConsoleMenuClose(benable : windows_core::BOOL) -> windows_core::BOOL);
...
pub unsafe fn SetConsoleNlsMode(hconsole: super::super::Foundation::HANDLE, fdwnlsmode: u32) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn SetConsoleNlsMode(hconsole : super::super::Foundation:: HANDLE, fdwnlsmode : u32) -> windows_core::BOOL);
...
pub unsafe fn SetConsoleOS2OemFormat(fos2oemformat: bool) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn SetConsoleOS2OemFormat(fos2oemformat : windows_core::BOOL) -> windows_core::BOOL);
...
pub unsafe fn SetConsolePalette(hconsoleoutput: super::super::Foundation::HANDLE, hpalette: super::super::Graphics::Gdi::HPALETTE, dwusage: u32) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn SetConsolePalette(hconsoleoutput : super::super::Foundation:: HANDLE, hpalette : super::super::Graphics::Gdi:: HPALETTE, dwusage : u32) -> windows_core::BOOL);
...
pub unsafe fn ShowConsoleCursor(hconsoleoutput: super::super::Foundation::HANDLE, bshow: bool) -> i32 {
    windows_link::link!("kernel32.dll" "system" fn ShowConsoleCursor(hconsoleoutput : super::super::Foundation:: HANDLE, bshow : windows_core::BOOL) -> i32);
    unsafe { ShowConsoleCursor(hconsoleoutput, bshow.into()) }
}
#[inline]
pub unsafe fn UnregisterConsoleIME() -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn UnregisterConsoleIME() -> windows_core::BOOL);
...
pub unsafe fn VDMConsoleOperation(ifunction: u32, lpdata: Option<*mut core::ffi::c_void>) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn VDMConsoleOperation(ifunction : u32, lpdata : *mut core::ffi::c_void) -> windows_core::BOOL);
...
pub unsafe fn VerifyConsoleIoHandle(hiohandle: super::super::Foundation::HANDLE) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn VerifyConsoleIoHandle(hiohandle : super::super::Foundation:: HANDLE) -> windows_core::BOOL);
...
pub unsafe fn WriteConsoleInputVDMA(hconsoleinput: super::super::Foundation::HANDLE, lpbuffer: &[INPUT_RECORD], lpnumberofeventswritten: *mut u32) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn WriteConsoleInputVDMA(hconsoleinput : super::super::Foundation:: HANDLE, lpbuffer : *const INPUT_RECORD, nlength : u32, lpnumberofeventswritten : *mut u32) -> windows_core::BOOL);
...
pub unsafe fn WriteConsoleInputVDMW(hconsoleinput: super::super::Foundation::HANDLE, lpbuffer: &[INPUT_RECORD], lpnumberofeventswritten: *mut u32) -> windows_core::BOOL {
    windows_link::link!("kernel32.dll" "system" fn WriteConsoleInputVDMW(hconsoleinput : super::super::Foundation:: HANDLE, lpbuffer : *const INPUT_RECORD, nlength : u32, lpnumberofeventswritten : *mut u32) -> windows_core::BOOL);
