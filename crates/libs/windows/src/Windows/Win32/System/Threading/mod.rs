...
pub const CONDITION_VARIABLE_INIT: CONDITION_VARIABLE = CONDITION_VARIABLE { Ptr: 0 };
...
pub const INIT_ONCE_STATIC_INIT: INIT_ONCE = INIT_ONCE { Ptr: 0 };
...
pub const SRWLOCK_INIT: SRWLOCK = SRWLOCK { Ptr: 0 };
...
impl ::core::cmp::PartialEq for OVERRIDE_PREFETCH_PARAMETER {
    fn eq(&self, other: &Self) -> bool {
        self.Value == other.Value
    }
}
impl ::core::cmp::Eq for OVERRIDE_PREFETCH_PARAMETER {}
impl ::core::default::Default for OVERRIDE_PREFETCH_PARAMETER {
    fn default() -> Self {
        unsafe { ::core::mem::zeroed() }
    }
}
