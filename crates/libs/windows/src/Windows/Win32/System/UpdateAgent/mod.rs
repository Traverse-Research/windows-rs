...
pub trait IUpdateDownloaderEx_Impl: IUpdateDownloader_Impl {
    fn BeginDownload2(&self, downloadtype: DownloadType, onprogresschanged: windows_core::Ref<'_, windows_core::IUnknown>, oncompleted: windows_core::Ref<'_, windows_core::IUnknown>, state: &super::Variant::VARIANT) -> windows_core::Result<IDownloadJob>;
