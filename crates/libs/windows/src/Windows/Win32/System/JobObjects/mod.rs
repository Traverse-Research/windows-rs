...
pub const JOB_OBJECT_CPU_RATE_CONTROL_VALID_FLAGS: JOB_OBJECT_CPU_RATE_CONTROL = JOB_OBJECT_CPU_RATE_CONTROL(63u32);
...
pub const JobObjectNetworkAccountingInformation: JOBOBJECTINFOCLASS = JOBOBJECTINFOCLASS(51i32);
...
pub const JobObjectReserved28Information: JOBOBJECTINFOCLASS = JOBOBJECTINFOCLASS(50i32);
...
pub const MaxJobObjectInfoClass: JOBOBJECTINFOCLASS = JOBOBJECTINFOCLASS(52i32);
