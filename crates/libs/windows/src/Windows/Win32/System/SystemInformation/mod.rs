...
pub const CacheUnknown: PROCESSOR_CACHE_TYPE = PROCESSOR_CACHE_TYPE(4i32);
...
pub const DEVICEFAMILYDEVICEFORM_GAMING_CONSOLE: DEVICEFAMILYDEVICEFORM = DEVICEFAMILYDEVICEFORM(47u32);
pub const DEVICEFAMILYDEVICEFORM_GAMING_HANDHELD: DEVICEFAMILYDEVICEFORM = DEVICEFAMILYDEVICEFORM(46u32);
...
pub const DEVICEFAMILYDEVICEFORM_MAX: DEVICEFAMILYDEVICEFORM = DEVICEFAMILYDEVICEFORM(47u32);
...
pub const GlobalDataIdQpcBias: RTL_SYSTEM_GLOBAL_DATA_ID = RTL_SYSTEM_GLOBAL_DATA_ID(18i32);
pub const GlobalDataIdQpcBypassEnabled: RTL_SYSTEM_GLOBAL_DATA_ID = RTL_SYSTEM_GLOBAL_DATA_ID(16i32);
pub const GlobalDataIdQpcData: RTL_SYSTEM_GLOBAL_DATA_ID = RTL_SYSTEM_GLOBAL_DATA_ID(17i32);
...
pub const PRODUCT_ARM64_SERVER: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(120u32);
pub const PRODUCT_AZURESTACKHCI_SERVER_CORE: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(406u32);
pub const PRODUCT_AZURE_NANO_SERVER: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(169u32);
pub const PRODUCT_AZURE_SERVER_AGENTBRIDGE: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(208u32);
pub const PRODUCT_AZURE_SERVER_CLOUDHOST: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(199u32);
pub const PRODUCT_AZURE_SERVER_CLOUDMOS: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(200u32);
pub const PRODUCT_AZURE_SERVER_CORE: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(168u32);
pub const PRODUCT_AZURE_SERVER_NANOHOST: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(209u32);
...
pub const PRODUCT_CLOUD: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(178u32);
pub const PRODUCT_CLOUDE: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(183u32);
pub const PRODUCT_CLOUDEDITION: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(203u32);
pub const PRODUCT_CLOUDEDITIONN: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(202u32);
pub const PRODUCT_CLOUDEN: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(186u32);
pub const PRODUCT_CLOUDN: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(179u32);
pub const PRODUCT_CLOUD_HOST_INFRASTRUCTURE_SERVER: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(124u32);
pub const PRODUCT_CLOUD_STORAGE_SERVER: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(110u32);
...
pub const PRODUCT_CONNECTED_CAR: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(117u32);
pub const PRODUCT_CORE: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(101u32);
pub const PRODUCT_CORE_ARM: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(97u32);
pub const PRODUCT_CORE_CONNECTED: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(111u32);
pub const PRODUCT_CORE_CONNECTED_COUNTRYSPECIFIC: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(116u32);
pub const PRODUCT_CORE_CONNECTED_N: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(113u32);
pub const PRODUCT_CORE_CONNECTED_SINGLELANGUAGE: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(115u32);
...
pub const PRODUCT_DATACENTER_EVALUATION_SERVER_CORE: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(159u32);
pub const PRODUCT_DATACENTER_NANO_SERVER: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(143u32);
pub const PRODUCT_DATACENTER_SERVER: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(8u32);
pub const PRODUCT_DATACENTER_SERVER_AZURE_EDITION: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(407u32);
pub const PRODUCT_DATACENTER_SERVER_CORE: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(12u32);
pub const PRODUCT_DATACENTER_SERVER_CORE_AZURE_EDITION: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(408u32);
...
pub const PRODUCT_DATACENTER_WS_SERVER_CORE: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(147u32);
pub const PRODUCT_DATACENTER_WS_SERVER_CORE_AZURE_EDITION: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(409u32);
...
pub const PRODUCT_EMBEDDED: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(65u32);
pub const PRODUCT_EMBEDDED_A: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(88u32);
pub const PRODUCT_EMBEDDED_AUTOMOTIVE: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(85u32);
pub const PRODUCT_EMBEDDED_E: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(90u32);
pub const PRODUCT_EMBEDDED_EVAL: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(107u32);
pub const PRODUCT_EMBEDDED_E_EVAL: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(108u32);
pub const PRODUCT_EMBEDDED_INDUSTRY: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(89u32);
pub const PRODUCT_EMBEDDED_INDUSTRY_A: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(86u32);
pub const PRODUCT_EMBEDDED_INDUSTRY_A_E: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(92u32);
pub const PRODUCT_EMBEDDED_INDUSTRY_E: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(91u32);
pub const PRODUCT_EMBEDDED_INDUSTRY_EVAL: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(105u32);
pub const PRODUCT_EMBEDDED_INDUSTRY_E_EVAL: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(106u32);
pub const PRODUCT_ENTERPRISE: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(4u32);
pub const PRODUCT_ENTERPRISEG: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(171u32);
pub const PRODUCT_ENTERPRISEGN: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(172u32);
...
pub const PRODUCT_ENTERPRISE_SUBSCRIPTION: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(140u32);
pub const PRODUCT_ENTERPRISE_SUBSCRIPTION_N: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(141u32);
...
pub const PRODUCT_HOLOGRAPHIC: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(135u32);
pub const PRODUCT_HOLOGRAPHIC_BUSINESS: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(136u32);
...
pub const PRODUCT_HUBOS: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(180u32);
pub const PRODUCT_HYPERV: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(42u32);
pub const PRODUCT_INDUSTRY_HANDHELD: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(118u32);
pub const PRODUCT_IOTEDGEOS: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(187u32);
pub const PRODUCT_IOTENTERPRISE: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(188u32);
pub const PRODUCT_IOTENTERPRISEK: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(206u32);
pub const PRODUCT_IOTENTERPRISES: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(191u32);
pub const PRODUCT_IOTENTERPRISESEVAL: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(207u32);
pub const PRODUCT_IOTENTERPRISESK: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(205u32);
pub const PRODUCT_IOTOS: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(185u32);
pub const PRODUCT_IOTUAP: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(123u32);
pub const PRODUCT_LITE: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(189u32);
...
pub const PRODUCT_NANO_SERVER: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(109u32);
pub const PRODUCT_ONECOREUPDATEOS: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(182u32);
pub const PRODUCT_PPI_PRO: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(119u32);
...
pub const PRODUCT_PROFESSIONAL_EMBEDDED: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(58u32);
pub const PRODUCT_PROFESSIONAL_N: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(49u32);
pub const PRODUCT_PROFESSIONAL_S: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(127u32);
pub const PRODUCT_PROFESSIONAL_STUDENT: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(112u32);
pub const PRODUCT_PROFESSIONAL_STUDENT_N: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(114u32);
pub const PRODUCT_PROFESSIONAL_S_N: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(128u32);
pub const PRODUCT_PROFESSIONAL_WMC: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(103u32);
pub const PRODUCT_PRO_CHINA: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(139u32);
pub const PRODUCT_PRO_FOR_EDUCATION: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(164u32);
pub const PRODUCT_PRO_FOR_EDUCATION_N: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(165u32);
pub const PRODUCT_PRO_SINGLE_LANGUAGE: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(138u32);
...
pub const PRODUCT_SERVERRDSH: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(175u32);
...
pub const PRODUCT_SOLUTION_EMBEDDEDSERVER_CORE: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(57u32);
...
pub const PRODUCT_STANDARD_EVALUATION_SERVER_CORE: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(160u32);
pub const PRODUCT_STANDARD_NANO_SERVER: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(144u32);
pub const PRODUCT_STANDARD_SERVER: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(7u32);
pub const PRODUCT_STANDARD_SERVER_CORE: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(13u32);
...
pub const PRODUCT_STANDARD_WS_SERVER_CORE: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(148u32);
...
pub const PRODUCT_THINPC: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(87u32);
...
pub const PRODUCT_UNLICENSED: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(2882382797u32);
pub const PRODUCT_UTILITY_VM: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(149u32);
pub const PRODUCT_VALIDATION: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(204u32);
...
pub const PRODUCT_WNC: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(210u32);
pub const PRODUCT_XBOX_DURANGOHOSTOS: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(196u32);
pub const PRODUCT_XBOX_ERAOS: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(195u32);
pub const PRODUCT_XBOX_GAMEOS: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(194u32);
pub const PRODUCT_XBOX_KEYSTONE: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(198u32);
pub const PRODUCT_XBOX_SCARLETTHOSTOS: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(197u32);
pub const PRODUCT_XBOX_SYSTEMOS: OS_PRODUCT_TYPE = OS_PRODUCT_TYPE(192u32);
