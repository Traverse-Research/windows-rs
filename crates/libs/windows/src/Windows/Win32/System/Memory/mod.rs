...
pub unsafe fn GetMemoryNumaClosestInitiatorNode(targetnodenumber: u32, initiatornodenumber: *mut u32) -> windows_core::BOOL {
    windows_link::link!("api-ms-win-core-memory-l1-1-9.dll" "system" fn GetMemoryNumaClosestInitiatorNode(targetnodenumber : u32, initiatornodenumber : *mut u32) -> windows_core::BOOL);
...
pub unsafe fn GetMemoryNumaPerformanceInformation(nodenumber: u32, datatype: u8, perfinfo: *mut *mut WIN32_MEMORY_NUMA_PERFORMANCE_INFORMATION_OUTPUT) -> windows_core::BOOL {
    windows_link::link!("api-ms-win-core-memory-l1-1-9.dll" "system" fn GetMemoryNumaPerformanceInformation(nodenumber : u32, datatype : u8, perfinfo : *mut *mut WIN32_MEMORY_NUMA_PERFORMANCE_INFORMATION_OUTPUT) -> windows_core::BOOL);
