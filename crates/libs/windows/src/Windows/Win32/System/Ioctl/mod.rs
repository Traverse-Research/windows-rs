...
pub const NVMeDataTypeFeatureEx: STORAGE_PROTOCOL_NVME_DATA_TYPE = STORAGE_PROTOCOL_NVME_DATA_TYPE(5i32);
...
pub const NVMeDataTypeLogPageEx: STORAGE_PROTOCOL_NVME_DATA_TYPE = STORAGE_PROTOCOL_NVME_DATA_TYPE(4i32);
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct STORAGE_ICE_TYPE(pub i32);
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq)]
...
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct STORAGE_STACK_TYPE(pub i32);
...
pub const StorageAdapterProtocolSpecificPropertyEx: STORAGE_PROPERTY_ID = STORAGE_PROPERTY_ID(67i32);
...
pub const StorageDeviceProtocolSpecificPropertyEx: STORAGE_PROPERTY_ID = STORAGE_PROPERTY_ID(68i32);
...
pub const StorageStackProperty: STORAGE_PROPERTY_ID = STORAGE_PROPERTY_ID(66i32);
pub const StorageStackTypeNVMe: STORAGE_STACK_TYPE = STORAGE_STACK_TYPE(2i32);
pub const StorageStackTypeScsi: STORAGE_STACK_TYPE = STORAGE_STACK_TYPE(1i32);
pub const StorageStackTypeUnknown: STORAGE_STACK_TYPE = STORAGE_STACK_TYPE(0i32);
