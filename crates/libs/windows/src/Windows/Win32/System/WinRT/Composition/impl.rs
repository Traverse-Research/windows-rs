...
pub trait ICompositorInterop2_Impl: Sized {
    ...
    fn CreateCompositionTexture(&self, d3dtexture: ::core::option::Option<&::windows_core::IUnknown>) -> ::windows_core::Result<super::super::super::super::UI::Composition::CompositionTexture>;
}
#[cfg(feature = "UI_Composition")]
