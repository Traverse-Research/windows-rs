...
pub unsafe fn WTSActiveSessionExists(pbactivesessionexists: *mut windows_core::BOOL) -> windows_core::BOOL {
    windows_link::link!("wtsapi32.dll" "system" fn WTSActiveSessionExists(pbactivesessionexists : *mut windows_core::BOOL) -> windows_core::BOOL);
...
{
    windows_link::link!("wtsapi32.dll" "system" fn WTSCloudAuthConvertAssertionToSerializedUserCredential(cloudauthhandle : WTS_CLOUD_AUTH_HANDLE, assertion : windows_core::PCSTR, assertionlength : u32, resourceid : windows_core::PCWSTR, usercredential : *mut *mut WTS_SERIALIZED_USER_CREDENTIAL) -> windows_core::BOOL);
...
pub unsafe fn WTSCloudAuthDuplicateSerializedUserCredential(usercredential: *const WTS_SERIALIZED_USER_CREDENTIAL, duplicatedusercredential: *mut *mut WTS_SERIALIZED_USER_CREDENTIAL) -> windows_core::BOOL {
    windows_link::link!("wtsapi32.dll" "system" fn WTSCloudAuthDuplicateSerializedUserCredential(usercredential : *const WTS_SERIALIZED_USER_CREDENTIAL, duplicatedusercredential : *mut *mut WTS_SERIALIZED_USER_CREDENTIAL) -> windows_core::BOOL);
...
pub unsafe fn WTSCloudAuthGetServerNonce(cloudauthhandle: WTS_CLOUD_AUTH_HANDLE, servernonce: *mut windows_core::PWSTR) -> windows_core::BOOL {
    windows_link::link!("wtsapi32.dll" "system" fn WTSCloudAuthGetServerNonce(cloudauthhandle : WTS_CLOUD_AUTH_HANDLE, servernonce : *mut windows_core::PWSTR) -> windows_core::BOOL);
...
pub unsafe fn WTSCloudAuthNetworkLogonWithSerializedCredential(cloudauthhandle: WTS_CLOUD_AUTH_HANDLE, usercredential: *const WTS_SERIALIZED_USER_CREDENTIAL, token: *mut super::super::Foundation::HANDLE) -> windows_core::BOOL {
    windows_link::link!("wtsapi32.dll" "system" fn WTSCloudAuthNetworkLogonWithSerializedCredential(cloudauthhandle : WTS_CLOUD_AUTH_HANDLE, usercredential : *const WTS_SERIALIZED_USER_CREDENTIAL, token : *mut super::super::Foundation:: HANDLE) -> windows_core::BOOL);
...
pub unsafe fn WTSCloudAuthOpen(activityid: *const windows_core::GUID) -> WTS_CLOUD_AUTH_HANDLE {
    windows_link::link!("wtsapi32.dll" "system" fn WTSCloudAuthOpen(activityid : *const windows_core::GUID) -> WTS_CLOUD_AUTH_HANDLE);
...
impl windows_core::Free for WTS_CLOUD_AUTH_HANDLE {
    ...
    unsafe fn free(&mut self) {
        if !self.is_invalid() {
            windows_link::link!("wtsapi32.dll" "system" fn WTSCloudAuthClose(cloudauthhandle : *mut core::ffi::c_void));
            unsafe {
