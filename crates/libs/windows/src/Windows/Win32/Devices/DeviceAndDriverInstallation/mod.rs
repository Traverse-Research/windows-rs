...
pub const GUID_DEVCLASS_AUDIOPROCESSINGOBJECT: windows_core::GUID = windows_core::GUID::from_u128(0x5989fce8_9cd0_467d_8a6a_5419e31529d4);
...
pub const GUID_DEVCLASS_I3C: windows_core::GUID = windows_core::GUID::from_u128(0x13cfe1b1_6b17_424c_ac3f_16ace8733898);
...
pub const GUID_KERNEL_SOFT_RESTART_PRE_COMPLETE: windows_core::GUID = windows_core::GUID::from_u128(0xaf855082_530b_4a85_b5a6_120b63089451);
...
pub const GUID_PCI_LINK_CONFIG_INTERFACE: windows_core::GUID = windows_core::GUID::from_u128(0x67593984_7cc0_4760_8d01_cbffd2d080f7);
...
pub const GUID_POWER_LIMIT_INTERFACE: windows_core::GUID = windows_core::GUID::from_u128(0x3b96f4f2_ce49_44d1_91f8_652b8121e93a);
...
pub const INFSTR_KEY_BOOTFLAGS: windows_core::PCWSTR = windows_core::w!("BootFlags");
...
pub const INFSTR_KEY_COMPONENTIDS: windows_core::PCWSTR = windows_core::w!("ComponentIds");
pub const INFSTR_KEY_COM_CLASS_DESCRIPTION: windows_core::PCWSTR = windows_core::w!("Description");
pub const INFSTR_KEY_COM_CLASS_THREADING_MODEL: windows_core::PCWSTR = windows_core::w!("ThreadingModel");
pub const INFSTR_KEY_COM_SERVER_ADD_COM_CLASS: windows_core::PCWSTR = windows_core::w!("AddComClass");
pub const INFSTR_KEY_COM_SERVER_BINARY: windows_core::PCWSTR = windows_core::w!("ServerBinary");
pub const INFSTR_KEY_COM_SERVER_BINARY_WOW64: windows_core::PCWSTR = windows_core::w!("ServerBinaryWow64");
pub const INFSTR_KEY_COM_SERVER_TYPE: windows_core::PCWSTR = windows_core::w!("ServerType");
...
pub const INFSTR_SUBKEY_COM: windows_core::PCWSTR = windows_core::w!("COM");
pub const INFSTR_SUBKEY_COMPONENTS: windows_core::PCWSTR = windows_core::w!("Components");
...
pub const SPQ_SCAN_USE_OEM_CATALOGS: SETUPSCANFILEQUEUE_FLAGS = SETUPSCANFILEQUEUE_FLAGS(2048u32);
...
pub const SPSVCINST_NOCLOBBER_BOOTFLAGS: SPSVCINST_FLAGS = SPSVCINST_FLAGS(262144u32);
...
pub const SZ_KEY_ADDCOMCLASS: windows_core::PCWSTR = windows_core::w!("AddComClass");
pub const SZ_KEY_ADDCOMPONENT: windows_core::PCWSTR = windows_core::w!("AddComponent");
pub const SZ_KEY_ADDCOMSERVER: windows_core::PCWSTR = windows_core::w!("AddComServer");
