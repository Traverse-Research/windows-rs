#[inline]
pub unsafe fn EXPERIMENTAL_WinBioGetEssState() -> windows_core::Result<u64> {
    windows_link::link!("winbio.dll" "system" fn EXPERIMENTAL_WinBioGetEssState(essstate : *mut u64) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        EXPERIMENTAL_WinBioGetEssState(&mut result__).map(|| result__)
    }
}
#[inline]
...
pub unsafe fn WinBioIsESSCapable() -> windows_core::Result<u8> {
    windows_link::link!("winbio.dll" "system" fn WinBioIsESSCapable(value : *mut u8) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
pub const EXPERIMENTAL_WINBIO_ESS_BLOCKED_NON_ESS_CAMERA: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS(16384i32);
pub const EXPERIMENTAL_WINBIO_ESS_BLOCKED_NON_ESS_FPR: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS(8192i32);
pub const EXPERIMENTAL_WINBIO_ESS_MANAGED_BY_POLICY: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS(128i32);
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_ENABLEMENT: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS(64i32);
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_FACE_SENSOR: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS(1024i32);
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_FPR_SENSOR: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS(2048i32);
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_ISOLATED_PROCESS: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS(4096i32);
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_NON_VBS_BIOMETRIC_ENROLLMENT_ABSENCE: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS(256i32);
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_NON_VBS_WINDOWS_HELLO_ABSENCE: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS(4i32);
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_TPM2: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS(1i32);
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_VBS_BIOMETRIC_ENROLLMENT: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS(512i32);
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_VBS_CAPABLE: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS(2i32);
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_VBS_ENCRYPTION_KEY: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS(32i32);
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_VBS_RUNNING: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS(16i32);
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_VBS_WINDOWS_HELLO: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS(8i32);
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS(pub i32);
