...
pub trait IAudioProcessingObjectPreferredFormatSupport_Impl: windows_core::IUnknownImpl {
    fn GetPreferredInputFormat(&self, outputformat: windows_core::Ref<'_, IAudioMediaType>) -> windows_core::Result<IAudioMediaType>;
    fn GetPreferredOutputFormat(&self, inputformat: windows_core::Ref<'_, IAudioMediaType>) -> windows_core::Result<IAudioMediaType>;
}
