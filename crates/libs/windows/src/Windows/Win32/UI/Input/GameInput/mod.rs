...
pub unsafe fn GameInputCreate() -> windows_core::Result<IGameInput> {
    windows_link::link!("gameinput.dll" "system" fn GameInputCreate(gameinput : *mut * mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
...
pub type GameInputDeviceCallback = Option<unsafe extern "system" fn(callbacktoken: u64, context: *const core::ffi::c_void, device: windows_core::Ref<'_, IGameInputDevice>, timestamp: u64, currentstatus: GameInputDeviceStatus, previousstatus: GameInputDeviceStatus)>;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub type GameInputKeyboardLayoutCallback = Option<unsafe extern "system" fn(callbacktoken: u64, context: *const core::ffi::c_void, device: windows_core::Ref<'_, IGameInputDevice>, timestamp: u64, currentlayout: u32, previouslayout: u32)>;
#[repr(transparent)]
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
...
pub type GameInputReadingCallback = Option<unsafe extern "system" fn(callbacktoken: u64, context: *const core::ffi::c_void, reading: windows_core::Ref<'_, IGameInputReading>, hasoverrunoccurred: bool)>;
...
pub type GameInputSystemButtonCallback = Option<unsafe extern "system" fn(callbacktoken: u64, context: *const core::ffi::c_void, device: windows_core::Ref<'_, IGameInputDevice>, timestamp: u64, currentbuttons: GameInputSystemButtons, previousbuttons: GameInputSystemButtons)>;
...
pub trait IGameInput_Impl: windows_core::IUnknownImpl {
    ...
    fn GetCurrentReading(&self, inputkind: GameInputKind, device: windows_core::Ref<'_, IGameInputDevice>) -> windows_core::Result<IGameInputReading>;
    fn GetNextReading(&self, referencereading: windows_core::Ref<'_, IGameInputReading>, inputkind: GameInputKind, device: windows_core::Ref<'_, IGameInputDevice>) -> windows_core::Result<IGameInputReading>;
    fn GetPreviousReading(&self, referencereading: windows_core::Ref<'_, IGameInputReading>, inputkind: GameInputKind, device: windows_core::Ref<'_, IGameInputDevice>) -> windows_core::Result<IGameInputReading>;
    fn GetTemporalReading(&self, timestamp: u64, device: windows_core::Ref<'_, IGameInputDevice>) -> windows_core::Result<IGameInputReading>;
    fn RegisterReadingCallback(&self, device: windows_core::Ref<'_, IGameInputDevice>, inputkind: GameInputKind, analogthreshold: f32, context: *const core::ffi::c_void, callbackfunc: GameInputReadingCallback, callbacktoken: *mut u64) -> windows_core::Result<()>;
    fn RegisterDeviceCallback(&self, device: windows_core::Ref<'_, IGameInputDevice>, inputkind: GameInputKind, statusfilter: GameInputDeviceStatus, enumerationkind: GameInputEnumerationKind, context: *const core::ffi::c_void, callbackfunc: GameInputDeviceCallback, callbacktoken: *mut u64) -> windows_core::Result<()>;
    fn RegisterSystemButtonCallback(&self, device: windows_core::Ref<'_, IGameInputDevice>, buttonfilter: GameInputSystemButtons, context: *const core::ffi::c_void, callbackfunc: GameInputSystemButtonCallback, callbacktoken: *mut u64) -> windows_core::Result<()>;
    fn RegisterKeyboardLayoutCallback(&self, device: windows_core::Ref<'_, IGameInputDevice>, context: *const core::ffi::c_void, callbackfunc: GameInputKeyboardLayoutCallback, callbacktoken: *mut u64) -> windows_core::Result<()>;
    ...
    fn FindDeviceFromObject(&self, value: windows_core::Ref<'_, windows_core::IUnknown>) -> windows_core::Result<IGameInputDevice>;
...
pub trait IGameInputDevice_Impl: windows_core::IUnknownImpl {
    ...
    fn SetRawDeviceFeature(&self, report: windows_core::Ref<'_, IGameInputRawDeviceReport>) -> windows_core::Result<()>;
    fn SendRawDeviceOutput(&self, report: windows_core::Ref<'_, IGameInputRawDeviceReport>) -> windows_core::Result<()>;
    fn SendRawDeviceOutputWithResponse(&self, requestreport: windows_core::Ref<'_, IGameInputRawDeviceReport>) -> windows_core::Result<IGameInputRawDeviceReport>;
...
pub trait IGameInputForceFeedbackEffect_Impl: windows_core::IUnknownImpl {
    fn GetDevice(&self, device: windows_core::OutRef<'_, IGameInputDevice>);
...
pub trait IGameInputReading_Impl: windows_core::IUnknownImpl {
    ...
    fn GetDevice(&self, device: windows_core::OutRef<'_, IGameInputDevice>);
    fn GetRawReport(&self, report: windows_core::OutRef<'_, IGameInputRawDeviceReport>) -> bool;
