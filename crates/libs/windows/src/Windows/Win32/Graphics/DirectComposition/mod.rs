...
pub trait IDCompositionDynamicTexture_Impl: windows_core::IUnknownImpl {
    fn SetTexture(&self, ptexture: windows_core::Ref<'_, IDCompositionTexture>, prects: *const super::super::Foundation::RECT, rectcount: usize) -> windows_core::Result<()>;
    fn SetTexture2(&self, ptexture: windows_core::Ref<'_, IDCompositionTexture>) -> windows_core::Result<()>;
}
