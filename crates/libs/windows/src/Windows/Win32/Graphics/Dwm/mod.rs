...
pub const DWMWA_BORDER_MARGINS: DWMWINDOWATTRIBUTE = DWMWINDOWATTRIBUTE(40i32);
...
pub const DWMWA_LAST: DWMWINDOWATTRIBUTE = DWMWINDOWATTRIBUTE(41i32);
...
pub const DWMWA_REDIRECTIONBITMAP_ALPHA: DWMWINDOWATTRIBUTE = DWMWINDOWATTRIBUTE(39i32);
