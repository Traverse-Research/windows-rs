...
pub trait ID3DShaderCacheApplication_Impl: windows_core::IUnknownImpl {
    ...
    fn RemoveComponent(&self, pcomponent: windows_core::Ref<'_, ID3DShaderCacheComponent>) -> windows_core::Result<()>;
...
pub trait ID3DShaderCacheInstaller_Impl: windows_core::IUnknownImpl {
    ...
    fn RemoveApplication(&self, papplication: windows_core::Ref<'_, ID3DShaderCacheApplication>) -> windows_core::Result<()>;
...
pub trait ID3DShaderCacheInstallerClient_Impl {
    ...
    fn HandleDriverUpdate(&self, pinstaller: windows_core::Ref<'_, ID3DShaderCacheInstaller>) -> windows_core::Result<()>;
}
...
pub trait ID3DShaderCacheInstallerFactory_Impl: windows_core::IUnknownImpl {
    fn CreateInstaller(&self, pclient: windows_core::Ref<'_, ID3DShaderCacheInstallerClient>, riid: *const windows_core::GUID, ppvinstaller: *mut *mut core::ffi::c_void) -> windows_core::Result<()>;
    fn CreateExplorer(&self, punknown: windows_core::Ref<'_, windows_core::IUnknown>, riid: *const windows_core::GUID, ppvexplorer: *mut *mut core::ffi::c_void) -> windows_core::Result<()>;
}
