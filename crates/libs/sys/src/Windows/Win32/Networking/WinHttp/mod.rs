...
windows_targets::link!("winhttp.dll" "system" fn WinHttpProtocolCompleteUpgrade(hrequest : *const core::ffi::c_void, dwcontext : usize) -> *mut core::ffi::c_void);
windows_targets::link!("winhttp.dll" "system" fn WinHttpProtocolReceive(protocolhandle : *const core::ffi::c_void, flags : u64, pvbuffer : *mut core::ffi::c_void, dwbufferlength : u32, pdwbytesread : *mut u32) -> u32);
windows_targets::link!("winhttp.dll" "system" fn WinHttpProtocolSend(protocolhandle : *const core::ffi::c_void, flags : u64, pvbuffer : *const core::ffi::c_void, dwbufferlength : u32) -> u32);
...
pub const WINHTTP_PROTOCOL_RECEIVE_OPERATION: WINHTTP_PROTOCOL_OPERATION = 1i32;
pub const WINHTTP_PROTOCOL_SEND_OPERATION: WINHTTP_PROTOCOL_OPERATION = 0i32;
...
pub const WinHttpFastForwardingStateClientSideFailed: WINHTTP_FAST_FORWARDING_STATE = 2i32;
pub const WinHttpFastForwardingStateInProgress: WINHTTP_FAST_FORWARDING_STATE = 0i32;
pub const WinHttpFastForwardingStateServerSideFailed: WINHTTP_FAST_FORWARDING_STATE = 3i32;
pub const WinHttpFastForwardingStateSucceeded: WINHTTP_FAST_FORWARDING_STATE = 1i32;
...
pub const WinHttpProxySettingsTypeXBox: WINHTTP_PROXY_SETTINGS_TYPE = 3i32;
