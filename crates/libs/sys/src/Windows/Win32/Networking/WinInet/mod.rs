...
pub const PROOF_OF_POSSESSION_ALLOW_SILENT_REQUESTS: PROOF_OF_POSSESSION_FLAGS = 1u32;
pub const PROOF_OF_POSSESSION_DEFAULT: PROOF_OF_POSSESSION_FLAGS = 0u32;
pub type PROOF_OF_POSSESSION_FLAGS = u32;
