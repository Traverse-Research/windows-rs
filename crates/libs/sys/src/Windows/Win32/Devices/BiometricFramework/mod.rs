windows_targets::link!("winbio.dll" "system" fn EXPERIMENTAL_WinBioGetEssState(essstate : *mut u64) -> windows_sys::core::HRESULT);
...
pub const EXPERIMENTAL_WINBIO_ESS_BLOCKED_NON_ESS_CAMERA: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 16384i32;
pub const EXPERIMENTAL_WINBIO_ESS_BLOCKED_NON_ESS_FPR: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 8192i32;
pub const EXPERIMENTAL_WINBIO_ESS_MANAGED_BY_POLICY: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 128i32;
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_ENABLEMENT: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 64i32;
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_FACE_SENSOR: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 1024i32;
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_FPR_SENSOR: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 2048i32;
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_ISOLATED_PROCESS: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 4096i32;
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_NON_VBS_BIOMETRIC_ENROLLMENT_ABSENCE: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 256i32;
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_NON_VBS_WINDOWS_HELLO_ABSENCE: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 4i32;
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_TPM2: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 1i32;
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_VBS_BIOMETRIC_ENROLLMENT: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 512i32;
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_VBS_CAPABLE: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 2i32;
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_VBS_ENCRYPTION_KEY: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 32i32;
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_VBS_RUNNING: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 16i32;
pub const EXPERIMENTAL_WINBIO_ESS_REQUIRES_VBS_WINDOWS_HELLO: EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = 8i32;
pub type EXPERIMENTAL_WINBIO_ESS_STATE_FLAGS = i32;
