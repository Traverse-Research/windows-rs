...
pub const COPYENGINE_S_PENDING_BATCH_COPY: windows_sys::core::HRESULT = 0x270011_u32 as _;
...
pub const FOLDERTYPEID_VersionControl: windows_sys::core::GUID = windows_sys::core::GUID::from_u128(0x69f1e26b_ec64_4280_bc83_f1eb887ec35a);
