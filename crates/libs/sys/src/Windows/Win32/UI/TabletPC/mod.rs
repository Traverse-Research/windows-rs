...
windows_targets::link!("inkobjcore.dll" "system" fn CloneContext(hrc : HRECOCONTEXT, pclonehrc : *mut HRECOCONTEXT) -> windows_sys::core::HRESULT);
...
windows_targets::link!("inkobjcore.dll" "system" fn DestroyAlternate(hrcalt : HRECOALT) -> windows_sys::core::HRESULT);
...
windows_targets::link!("inkobjcore.dll" "system" fn GetContextPreferenceFlags(hrc : HRECOCONTEXT, pdwcontextpreferenceflags : *mut u32) -> windows_sys::core::HRESULT);
windows_targets::link!("inkobjcore.dll" "system" fn GetContextPropertyList(hrc : HRECOCONTEXT, pcproperties : *mut u32, ppropertyguids : *mut windows_sys::core::GUID) -> windows_sys::core::HRESULT);
windows_targets::link!("inkobjcore.dll" "system" fn GetContextPropertyValue(hrc : HRECOCONTEXT, pguid : *mut windows_sys::core::GUID, pcbsize : *mut u32, pproperty : *mut u8) -> windows_sys::core::HRESULT);
windows_targets::link!("inkobjcore.dll" "system" fn GetEnabledUnicodeRanges(hrc : HRECOCONTEXT, pcranges : *mut u32, pcr : *mut CHARACTER_RANGE) -> windows_sys::core::HRESULT);
windows_targets::link!("inkobjcore.dll" "system" fn GetGuide(hrc : HRECOCONTEXT, pguide : *mut RECO_GUIDE, piindex : *mut u32) -> windows_sys::core::HRESULT);
...
windows_targets::link!("inkobjcore.dll" "system" fn GetPreferredPacketDescription(hrec : HRECOGNIZER, ppacketdescription : *mut PACKET_DESCRIPTION) -> windows_sys::core::HRESULT);
...
windows_targets::link!("inkobjcore.dll" "system" fn ResetContext(hrc : HRECOCONTEXT) -> windows_sys::core::HRESULT);
windows_targets::link!("inkobjcore.dll" "system" fn SetCACMode(hrc : HRECOCONTEXT, imode : i32) -> windows_sys::core::HRESULT);
windows_targets::link!("inkobjcore.dll" "system" fn SetContextPropertyValue(hrc : HRECOCONTEXT, pguid : *mut windows_sys::core::GUID, cbsize : u32, pproperty : *mut u8) -> windows_sys::core::HRESULT);
