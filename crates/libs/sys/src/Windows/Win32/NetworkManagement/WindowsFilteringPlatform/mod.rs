...
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmCalloutAdd0(enginehandle : FWPM_ENGINE_HANDLE, callout : *const FWPM_CALLOUT0, sd : super::super::Security:: PSECURITY_DESCRIPTOR, id : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmCalloutCreateEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumtemplate : *const FWPM_CALLOUT_ENUM_TEMPLATE0, enumhandle : *mut FWPM_CALLOUT_ENUM_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmCalloutDeleteById0(enginehandle : FWPM_ENGINE_HANDLE, id : u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmCalloutDeleteByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmCalloutDestroyEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_CALLOUT_ENUM_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmCalloutEnum0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_CALLOUT_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut FWPM_CALLOUT0, numentriesreturned : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmCalloutGetById0(enginehandle : FWPM_ENGINE_HANDLE, id : u32, callout : *mut *mut FWPM_CALLOUT0) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmCalloutGetByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID, callout : *mut *mut FWPM_CALLOUT0) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmCalloutGetSecurityInfoByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID, securityinfo : u32, sidowner : *mut super::super::Security:: PSID, sidgroup : *mut super::super::Security:: PSID, dacl : *mut *mut super::super::Security:: ACL, sacl : *mut *mut super::super::Security:: ACL, securitydescriptor : *mut super::super::Security:: PSECURITY_DESCRIPTOR) -> u32);
#[cfg(feature = "Win32_Security")]
...
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmCalloutSubscribeChanges0(enginehandle : FWPM_ENGINE_HANDLE, subscription : *const FWPM_CALLOUT_SUBSCRIPTION0, callback : FWPM_CALLOUT_CHANGE_CALLBACK0, context : *const core::ffi::c_void, changehandle : *mut super::super::Foundation:: HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmCalloutSubscriptionsGet0(enginehandle : FWPM_ENGINE_HANDLE, entries : *mut *mut *mut FWPM_CALLOUT_SUBSCRIPTION0, numentries : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmCalloutUnsubscribeChanges0(enginehandle : FWPM_ENGINE_HANDLE, changehandle : super::super::Foundation:: HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmConnectionCreateEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumtemplate : *const FWPM_CONNECTION_ENUM_TEMPLATE0, enumhandle : *mut FWPM_CONNECTION_ENUM_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmConnectionDestroyEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_CONNECTION_ENUM_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmConnectionEnum0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_CONNECTION_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut FWPM_CONNECTION0, numentriesreturned : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmConnectionGetById0(enginehandle : FWPM_ENGINE_HANDLE, id : u64, connection : *mut *mut FWPM_CONNECTION0) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmConnectionGetSecurityInfo0(enginehandle : FWPM_ENGINE_HANDLE, securityinfo : u32, sidowner : *mut super::super::Security:: PSID, sidgroup : *mut super::super::Security:: PSID, dacl : *mut *mut super::super::Security:: ACL, sacl : *mut *mut super::super::Security:: ACL, securitydescriptor : *mut super::super::Security:: PSECURITY_DESCRIPTOR) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmConnectionPolicyAdd0(enginehandle : FWPM_ENGINE_HANDLE, connectionpolicy : *const FWPM_PROVIDER_CONTEXT3, ipversion : FWP_IP_VERSION, weight : u64, numfilterconditions : u32, filterconditions : *const FWPM_FILTER_CONDITION0, sd : super::super::Security:: PSECURITY_DESCRIPTOR) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmConnectionPolicyDeleteByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmConnectionSetSecurityInfo0(enginehandle : FWPM_ENGINE_HANDLE, securityinfo : u32, sidowner : *const super::super::Security:: SID, sidgroup : *const super::super::Security:: SID, dacl : *const super::super::Security:: ACL, sacl : *const super::super::Security:: ACL) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmConnectionSubscribe0(enginehandle : FWPM_ENGINE_HANDLE, subscription : *const FWPM_CONNECTION_SUBSCRIPTION0, callback : FWPM_CONNECTION_CALLBACK0, context : *const core::ffi::c_void, eventshandle : *mut super::super::Foundation:: HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmConnectionUnsubscribe0(enginehandle : FWPM_ENGINE_HANDLE, eventshandle : super::super::Foundation:: HANDLE) -> u32);
...
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmEngineClose0(enginehandle : FWPM_ENGINE_HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmEngineGetOption0(enginehandle : FWPM_ENGINE_HANDLE, option : FWPM_ENGINE_OPTION, value : *mut *mut FWP_VALUE0) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmEngineGetSecurityInfo0(enginehandle : FWPM_ENGINE_HANDLE, securityinfo : u32, sidowner : *mut super::super::Security:: PSID, sidgroup : *mut super::super::Security:: PSID, dacl : *mut *mut super::super::Security:: ACL, sacl : *mut *mut super::super::Security:: ACL, securitydescriptor : *mut super::super::Security:: PSECURITY_DESCRIPTOR) -> u32);
#[cfg(all(feature = "Win32_Security", feature = "Win32_System_Rpc"))]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmEngineOpen0(servername : windows_sys::core::PCWSTR, authnservice : u32, authidentity : *const super::super::System::Rpc:: SEC_WINNT_AUTH_IDENTITY_W, session : *const FWPM_SESSION0, enginehandle : *mut FWPM_ENGINE_HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmEngineSetOption0(enginehandle : FWPM_ENGINE_HANDLE, option : FWPM_ENGINE_OPTION, newvalue : *const FWP_VALUE0) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmEngineSetSecurityInfo0(enginehandle : FWPM_ENGINE_HANDLE, securityinfo : u32, sidowner : *const super::super::Security:: SID, sidgroup : *const super::super::Security:: SID, dacl : *const super::super::Security:: ACL, sacl : *const super::super::Security:: ACL) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmFilterAdd0(enginehandle : FWPM_ENGINE_HANDLE, filter : *const FWPM_FILTER0, sd : super::super::Security:: PSECURITY_DESCRIPTOR, id : *mut u64) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmFilterCreateEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumtemplate : *const FWPM_FILTER_ENUM_TEMPLATE0, enumhandle : *mut FWPM_FILTER_ENUM_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmFilterDeleteById0(enginehandle : FWPM_ENGINE_HANDLE, id : u64) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmFilterDeleteByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmFilterDestroyEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_FILTER_ENUM_HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmFilterEnum0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_FILTER_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut FWPM_FILTER0, numentriesreturned : *mut u32) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmFilterGetById0(enginehandle : FWPM_ENGINE_HANDLE, id : u64, filter : *mut *mut FWPM_FILTER0) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmFilterGetByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID, filter : *mut *mut FWPM_FILTER0) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmFilterGetSecurityInfoByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID, securityinfo : u32, sidowner : *mut super::super::Security:: PSID, sidgroup : *mut super::super::Security:: PSID, dacl : *mut *mut super::super::Security:: ACL, sacl : *mut *mut super::super::Security:: ACL, securitydescriptor : *mut super::super::Security:: PSECURITY_DESCRIPTOR) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmFilterSetSecurityInfoByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID, securityinfo : u32, sidowner : *const super::super::Security:: SID, sidgroup : *const super::super::Security:: SID, dacl : *const super::super::Security:: ACL, sacl : *const super::super::Security:: ACL) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmFilterSubscribeChanges0(enginehandle : FWPM_ENGINE_HANDLE, subscription : *const FWPM_FILTER_SUBSCRIPTION0, callback : FWPM_FILTER_CHANGE_CALLBACK0, context : *const core::ffi::c_void, changehandle : *mut super::super::Foundation:: HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmFilterSubscriptionsGet0(enginehandle : FWPM_ENGINE_HANDLE, entries : *mut *mut *mut FWPM_FILTER_SUBSCRIPTION0, numentries : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmFilterUnsubscribeChanges0(enginehandle : FWPM_ENGINE_HANDLE, changehandle : super::super::Foundation:: HANDLE) -> u32);
...
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmIPsecTunnelDeleteByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmLayerCreateEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumtemplate : *const FWPM_LAYER_ENUM_TEMPLATE0, enumhandle : *mut FWPM_LAYER_ENUM_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmLayerDestroyEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_LAYER_ENUM_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmLayerEnum0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_LAYER_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut FWPM_LAYER0, numentriesreturned : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmLayerGetById0(enginehandle : FWPM_ENGINE_HANDLE, id : u16, layer : *mut *mut FWPM_LAYER0) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmLayerGetByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID, layer : *mut *mut FWPM_LAYER0) -> u32);
#[cfg(feature = "Win32_Security")]
...
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmLayerSetSecurityInfoByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID, securityinfo : u32, sidowner : *const super::super::Security:: SID, sidgroup : *const super::super::Security:: SID, dacl : *const super::super::Security:: ACL, sacl : *const super::super::Security:: ACL) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmNetEventCreateEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumtemplate : *const FWPM_NET_EVENT_ENUM_TEMPLATE0, enumhandle : *mut FWPM_NET_EVENT_ENUM_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmNetEventDestroyEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_NET_EVENT_ENUM_HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmNetEventEnum0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_NET_EVENT_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut FWPM_NET_EVENT0, numentriesreturned : *mut u32) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmNetEventEnum1(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_NET_EVENT_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut FWPM_NET_EVENT1, numentriesreturned : *mut u32) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmNetEventEnum2(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_NET_EVENT_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut FWPM_NET_EVENT2, numentriesreturned : *mut u32) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmNetEventEnum3(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_NET_EVENT_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut FWPM_NET_EVENT3, numentriesreturned : *mut u32) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmNetEventEnum4(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_NET_EVENT_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut FWPM_NET_EVENT4, numentriesreturned : *mut u32) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmNetEventEnum5(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_NET_EVENT_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut FWPM_NET_EVENT5, numentriesreturned : *mut u32) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmNetEventSubscribe0(enginehandle : FWPM_ENGINE_HANDLE, subscription : *const FWPM_NET_EVENT_SUBSCRIPTION0, callback : FWPM_NET_EVENT_CALLBACK0, context : *const core::ffi::c_void, eventshandle : *mut super::super::Foundation:: HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmNetEventSubscribe1(enginehandle : FWPM_ENGINE_HANDLE, subscription : *const FWPM_NET_EVENT_SUBSCRIPTION0, callback : FWPM_NET_EVENT_CALLBACK1, context : *const core::ffi::c_void, eventshandle : *mut super::super::Foundation:: HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmNetEventSubscribe2(enginehandle : FWPM_ENGINE_HANDLE, subscription : *const FWPM_NET_EVENT_SUBSCRIPTION0, callback : FWPM_NET_EVENT_CALLBACK2, context : *const core::ffi::c_void, eventshandle : *mut super::super::Foundation:: HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmNetEventSubscribe3(enginehandle : FWPM_ENGINE_HANDLE, subscription : *const FWPM_NET_EVENT_SUBSCRIPTION0, callback : FWPM_NET_EVENT_CALLBACK3, context : *const core::ffi::c_void, eventshandle : *mut super::super::Foundation:: HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmNetEventSubscribe4(enginehandle : FWPM_ENGINE_HANDLE, subscription : *const FWPM_NET_EVENT_SUBSCRIPTION0, callback : FWPM_NET_EVENT_CALLBACK4, context : *const core::ffi::c_void, eventshandle : *mut super::super::Foundation:: HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmNetEventSubscriptionsGet0(enginehandle : FWPM_ENGINE_HANDLE, entries : *mut *mut *mut FWPM_NET_EVENT_SUBSCRIPTION0, numentries : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmNetEventUnsubscribe0(enginehandle : FWPM_ENGINE_HANDLE, eventshandle : super::super::Foundation:: HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmNetEventsGetSecurityInfo0(enginehandle : FWPM_ENGINE_HANDLE, securityinfo : u32, sidowner : *mut super::super::Security:: PSID, sidgroup : *mut super::super::Security:: PSID, dacl : *mut *mut super::super::Security:: ACL, sacl : *mut *mut super::super::Security:: ACL, securitydescriptor : *mut super::super::Security:: PSECURITY_DESCRIPTOR) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmNetEventsSetSecurityInfo0(enginehandle : FWPM_ENGINE_HANDLE, securityinfo : u32, sidowner : *const super::super::Security:: SID, sidgroup : *const super::super::Security:: SID, dacl : *const super::super::Security:: ACL, sacl : *const super::super::Security:: ACL) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderAdd0(enginehandle : FWPM_ENGINE_HANDLE, provider : *const FWPM_PROVIDER0, sd : super::super::Security:: PSECURITY_DESCRIPTOR) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextAdd0(enginehandle : FWPM_ENGINE_HANDLE, providercontext : *const FWPM_PROVIDER_CONTEXT0, sd : super::super::Security:: PSECURITY_DESCRIPTOR, id : *mut u64) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextAdd1(enginehandle : FWPM_ENGINE_HANDLE, providercontext : *const FWPM_PROVIDER_CONTEXT1, sd : super::super::Security:: PSECURITY_DESCRIPTOR, id : *mut u64) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextAdd2(enginehandle : FWPM_ENGINE_HANDLE, providercontext : *const FWPM_PROVIDER_CONTEXT2, sd : super::super::Security:: PSECURITY_DESCRIPTOR, id : *mut u64) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextAdd3(enginehandle : FWPM_ENGINE_HANDLE, providercontext : *const FWPM_PROVIDER_CONTEXT3, sd : super::super::Security:: PSECURITY_DESCRIPTOR, id : *mut u64) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextCreateEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumtemplate : *const FWPM_PROVIDER_CONTEXT_ENUM_TEMPLATE0, enumhandle : *mut FWPM_PROVIDER_CONTEXT_ENUM_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextDeleteById0(enginehandle : FWPM_ENGINE_HANDLE, id : u64) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextDeleteByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextDestroyEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_PROVIDER_CONTEXT_ENUM_HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextEnum0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_PROVIDER_CONTEXT_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut FWPM_PROVIDER_CONTEXT0, numentriesreturned : *mut u32) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextEnum1(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_PROVIDER_CONTEXT_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut FWPM_PROVIDER_CONTEXT1, numentriesreturned : *mut u32) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextEnum2(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_PROVIDER_CONTEXT_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut FWPM_PROVIDER_CONTEXT2, numentriesreturned : *mut u32) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextEnum3(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_PROVIDER_CONTEXT_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut FWPM_PROVIDER_CONTEXT3, numentriesreturned : *mut u32) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextGetById0(enginehandle : FWPM_ENGINE_HANDLE, id : u64, providercontext : *mut *mut FWPM_PROVIDER_CONTEXT0) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextGetById1(enginehandle : FWPM_ENGINE_HANDLE, id : u64, providercontext : *mut *mut FWPM_PROVIDER_CONTEXT1) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextGetById2(enginehandle : FWPM_ENGINE_HANDLE, id : u64, providercontext : *mut *mut FWPM_PROVIDER_CONTEXT2) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextGetById3(enginehandle : FWPM_ENGINE_HANDLE, id : u64, providercontext : *mut *mut FWPM_PROVIDER_CONTEXT3) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextGetByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID, providercontext : *mut *mut FWPM_PROVIDER_CONTEXT0) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextGetByKey1(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID, providercontext : *mut *mut FWPM_PROVIDER_CONTEXT1) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextGetByKey2(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID, providercontext : *mut *mut FWPM_PROVIDER_CONTEXT2) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextGetByKey3(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID, providercontext : *mut *mut FWPM_PROVIDER_CONTEXT3) -> u32);
#[cfg(feature = "Win32_Security")]
...
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextSubscribeChanges0(enginehandle : FWPM_ENGINE_HANDLE, subscription : *const FWPM_PROVIDER_CONTEXT_SUBSCRIPTION0, callback : FWPM_PROVIDER_CONTEXT_CHANGE_CALLBACK0, context : *const core::ffi::c_void, changehandle : *mut super::super::Foundation:: HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextSubscriptionsGet0(enginehandle : FWPM_ENGINE_HANDLE, entries : *mut *mut *mut FWPM_PROVIDER_CONTEXT_SUBSCRIPTION0, numentries : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderContextUnsubscribeChanges0(enginehandle : FWPM_ENGINE_HANDLE, changehandle : super::super::Foundation:: HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderCreateEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumtemplate : *const FWPM_PROVIDER_ENUM_TEMPLATE0, enumhandle : *mut FWPM_PROVIDER_ENUM_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderDeleteByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderDestroyEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_PROVIDER_ENUM_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderEnum0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_PROVIDER_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut FWPM_PROVIDER0, numentriesreturned : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderGetByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID, provider : *mut *mut FWPM_PROVIDER0) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderGetSecurityInfoByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID, securityinfo : u32, sidowner : *mut super::super::Security:: PSID, sidgroup : *mut super::super::Security:: PSID, dacl : *mut *mut super::super::Security:: ACL, sacl : *mut *mut super::super::Security:: ACL, securitydescriptor : *mut super::super::Security:: PSECURITY_DESCRIPTOR) -> u32);
#[cfg(feature = "Win32_Security")]
...
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderSubscribeChanges0(enginehandle : FWPM_ENGINE_HANDLE, subscription : *const FWPM_PROVIDER_SUBSCRIPTION0, callback : FWPM_PROVIDER_CHANGE_CALLBACK0, context : *const core::ffi::c_void, changehandle : *mut super::super::Foundation:: HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderSubscriptionsGet0(enginehandle : FWPM_ENGINE_HANDLE, entries : *mut *mut *mut FWPM_PROVIDER_SUBSCRIPTION0, numentries : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmProviderUnsubscribeChanges0(enginehandle : FWPM_ENGINE_HANDLE, changehandle : super::super::Foundation:: HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmSessionCreateEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumtemplate : *const FWPM_SESSION_ENUM_TEMPLATE0, enumhandle : *mut FWPM_SESSION_ENUM_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmSessionDestroyEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_SESSION_ENUM_HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmSessionEnum0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_SESSION_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut FWPM_SESSION0, numentriesreturned : *mut u32) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmSubLayerAdd0(enginehandle : FWPM_ENGINE_HANDLE, sublayer : *const FWPM_SUBLAYER0, sd : super::super::Security:: PSECURITY_DESCRIPTOR) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmSubLayerCreateEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumtemplate : *const FWPM_SUBLAYER_ENUM_TEMPLATE0, enumhandle : *mut FWPM_SUBLAYER_ENUM_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmSubLayerDeleteByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmSubLayerDestroyEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_SUBLAYER_ENUM_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmSubLayerEnum0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : FWPM_SUBLAYER_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut FWPM_SUBLAYER0, numentriesreturned : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmSubLayerGetByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID, sublayer : *mut *mut FWPM_SUBLAYER0) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmSubLayerGetSecurityInfoByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID, securityinfo : u32, sidowner : *mut super::super::Security:: PSID, sidgroup : *mut super::super::Security:: PSID, dacl : *mut *mut super::super::Security:: ACL, sacl : *mut *mut super::super::Security:: ACL, securitydescriptor : *mut super::super::Security:: PSECURITY_DESCRIPTOR) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmSubLayerSetSecurityInfoByKey0(enginehandle : FWPM_ENGINE_HANDLE, key : *const windows_sys::core::GUID, securityinfo : u32, sidowner : *const super::super::Security:: SID, sidgroup : *const super::super::Security:: SID, dacl : *const super::super::Security:: ACL, sacl : *const super::super::Security:: ACL) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmSubLayerSubscribeChanges0(enginehandle : FWPM_ENGINE_HANDLE, subscription : *const FWPM_SUBLAYER_SUBSCRIPTION0, callback : FWPM_SUBLAYER_CHANGE_CALLBACK0, context : *const core::ffi::c_void, changehandle : *mut super::super::Foundation:: HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmSubLayerSubscriptionsGet0(enginehandle : FWPM_ENGINE_HANDLE, entries : *mut *mut *mut FWPM_SUBLAYER_SUBSCRIPTION0, numentries : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmSubLayerUnsubscribeChanges0(enginehandle : FWPM_ENGINE_HANDLE, changehandle : super::super::Foundation:: HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmSystemPortsGet0(enginehandle : FWPM_ENGINE_HANDLE, sysports : *mut *mut FWPM_SYSTEM_PORTS0) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmSystemPortsSubscribe0(enginehandle : FWPM_ENGINE_HANDLE, reserved : *const core::ffi::c_void, callback : FWPM_SYSTEM_PORTS_CALLBACK0, context : *const core::ffi::c_void, sysportshandle : *mut super::super::Foundation:: HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmSystemPortsUnsubscribe0(enginehandle : FWPM_ENGINE_HANDLE, sysportshandle : super::super::Foundation:: HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmTransactionAbort0(enginehandle : FWPM_ENGINE_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmTransactionBegin0(enginehandle : FWPM_ENGINE_HANDLE, flags : u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmTransactionCommit0(enginehandle : FWPM_ENGINE_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmvSwitchEventSubscribe0(enginehandle : FWPM_ENGINE_HANDLE, subscription : *const FWPM_VSWITCH_EVENT_SUBSCRIPTION0, callback : FWPM_VSWITCH_EVENT_CALLBACK0, context : *const core::ffi::c_void, subscriptionhandle : *mut super::super::Foundation:: HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmvSwitchEventUnsubscribe0(enginehandle : FWPM_ENGINE_HANDLE, subscriptionhandle : super::super::Foundation:: HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmvSwitchEventsGetSecurityInfo0(enginehandle : FWPM_ENGINE_HANDLE, securityinfo : u32, sidowner : *mut super::super::Security:: PSID, sidgroup : *mut super::super::Security:: PSID, dacl : *mut *mut super::super::Security:: ACL, sacl : *mut *mut super::super::Security:: ACL, securitydescriptor : *mut super::super::Security:: PSECURITY_DESCRIPTOR) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn FwpmvSwitchEventsSetSecurityInfo0(enginehandle : FWPM_ENGINE_HANDLE, securityinfo : u32, sidowner : *const super::super::Security:: SID, sidgroup : *const super::super::Security:: SID, dacl : *const super::super::Security:: ACL, sacl : *const super::super::Security:: ACL) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecDospGetSecurityInfo0(enginehandle : FWPM_ENGINE_HANDLE, securityinfo : u32, sidowner : *mut super::super::Security:: PSID, sidgroup : *mut super::super::Security:: PSID, dacl : *mut *mut super::super::Security:: ACL, sacl : *mut *mut super::super::Security:: ACL, securitydescriptor : *mut super::super::Security:: PSECURITY_DESCRIPTOR) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecDospGetStatistics0(enginehandle : FWPM_ENGINE_HANDLE, idpstatistics : *mut IPSEC_DOSP_STATISTICS0) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecDospSetSecurityInfo0(enginehandle : FWPM_ENGINE_HANDLE, securityinfo : u32, sidowner : *const super::super::Security:: SID, sidgroup : *const super::super::Security:: SID, dacl : *const super::super::Security:: ACL, sacl : *const super::super::Security:: ACL) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecDospStateCreateEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumtemplate : *const IPSEC_DOSP_STATE_ENUM_TEMPLATE0, enumhandle : *mut IPSEC_DOSP_STATE_ENUM_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecDospStateDestroyEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : IPSEC_DOSP_STATE_ENUM_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecDospStateEnum0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : IPSEC_DOSP_STATE_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut IPSEC_DOSP_STATE0, numentries : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecGetStatistics0(enginehandle : FWPM_ENGINE_HANDLE, ipsecstatistics : *mut IPSEC_STATISTICS0) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecGetStatistics1(enginehandle : FWPM_ENGINE_HANDLE, ipsecstatistics : *mut IPSEC_STATISTICS1) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecKeyManagerAddAndRegister0(enginehandle : FWPM_ENGINE_HANDLE, keymanager : *const IPSEC_KEY_MANAGER0, keymanagercallbacks : *const IPSEC_KEY_MANAGER_CALLBACKS0, keymgmthandle : *mut super::super::Foundation:: HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
...
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecKeyManagerSetSecurityInfoByKey0(enginehandle : FWPM_ENGINE_HANDLE, reserved : *const core::ffi::c_void, securityinfo : u32, sidowner : *const super::super::Security:: SID, sidgroup : *const super::super::Security:: SID, dacl : *const super::super::Security:: ACL, sacl : *const super::super::Security:: ACL) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecKeyManagerUnregisterAndDelete0(enginehandle : FWPM_ENGINE_HANDLE, keymgmthandle : super::super::Foundation:: HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecKeyManagersGet0(enginehandle : FWPM_ENGINE_HANDLE, entries : *mut *mut *mut IPSEC_KEY_MANAGER0, numentries : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextAddInbound0(enginehandle : FWPM_ENGINE_HANDLE, id : u64, inboundbundle : *const IPSEC_SA_BUNDLE0) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextAddInbound1(enginehandle : FWPM_ENGINE_HANDLE, id : u64, inboundbundle : *const IPSEC_SA_BUNDLE1) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextAddOutbound0(enginehandle : FWPM_ENGINE_HANDLE, id : u64, outboundbundle : *const IPSEC_SA_BUNDLE0) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextAddOutbound1(enginehandle : FWPM_ENGINE_HANDLE, id : u64, outboundbundle : *const IPSEC_SA_BUNDLE1) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextCreate0(enginehandle : FWPM_ENGINE_HANDLE, outboundtraffic : *const IPSEC_TRAFFIC0, inboundfilterid : *mut u64, id : *mut u64) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextCreate1(enginehandle : FWPM_ENGINE_HANDLE, outboundtraffic : *const IPSEC_TRAFFIC1, virtualiftunnelinfo : *const IPSEC_VIRTUAL_IF_TUNNEL_INFO0, inboundfilterid : *mut u64, id : *mut u64) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextCreateEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumtemplate : *const IPSEC_SA_CONTEXT_ENUM_TEMPLATE0, enumhandle : *mut IPSEC_SA_CONTEXT_ENUM_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextDeleteById0(enginehandle : FWPM_ENGINE_HANDLE, id : u64) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextDestroyEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : IPSEC_SA_CONTEXT_ENUM_HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextEnum0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : IPSEC_SA_CONTEXT_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut IPSEC_SA_CONTEXT0, numentriesreturned : *mut u32) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextEnum1(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : IPSEC_SA_CONTEXT_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut IPSEC_SA_CONTEXT1, numentriesreturned : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextExpire0(enginehandle : FWPM_ENGINE_HANDLE, id : u64) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextGetById0(enginehandle : FWPM_ENGINE_HANDLE, id : u64, sacontext : *mut *mut IPSEC_SA_CONTEXT0) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextGetById1(enginehandle : FWPM_ENGINE_HANDLE, id : u64, sacontext : *mut *mut IPSEC_SA_CONTEXT1) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextGetSpi0(enginehandle : FWPM_ENGINE_HANDLE, id : u64, getspi : *const IPSEC_GETSPI0, inboundspi : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextGetSpi1(enginehandle : FWPM_ENGINE_HANDLE, id : u64, getspi : *const IPSEC_GETSPI1, inboundspi : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextSetSpi0(enginehandle : FWPM_ENGINE_HANDLE, id : u64, getspi : *const IPSEC_GETSPI1, inboundspi : u32) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextSubscribe0(enginehandle : FWPM_ENGINE_HANDLE, subscription : *const IPSEC_SA_CONTEXT_SUBSCRIPTION0, callback : IPSEC_SA_CONTEXT_CALLBACK0, context : *const core::ffi::c_void, eventshandle : *mut super::super::Foundation:: HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextSubscriptionsGet0(enginehandle : FWPM_ENGINE_HANDLE, entries : *mut *mut *mut IPSEC_SA_CONTEXT_SUBSCRIPTION0, numentries : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextUnsubscribe0(enginehandle : FWPM_ENGINE_HANDLE, eventshandle : super::super::Foundation:: HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaContextUpdate0(enginehandle : FWPM_ENGINE_HANDLE, flags : u64, newvalues : *const IPSEC_SA_CONTEXT1) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaCreateEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumtemplate : *const IPSEC_SA_ENUM_TEMPLATE0, enumhandle : *mut IPSEC_SA_ENUM_HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
...
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaDbSetSecurityInfo0(enginehandle : FWPM_ENGINE_HANDLE, securityinfo : u32, sidowner : *const super::super::Security:: SID, sidgroup : *const super::super::Security:: SID, dacl : *const super::super::Security:: ACL, sacl : *const super::super::Security:: ACL) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaDestroyEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : IPSEC_SA_ENUM_HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaEnum0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : IPSEC_SA_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut IPSEC_SA_DETAILS0, numentriesreturned : *mut u32) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn IPsecSaEnum1(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : IPSEC_SA_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut IPSEC_SA_DETAILS1, numentriesreturned : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IkeextGetStatistics0(enginehandle : FWPM_ENGINE_HANDLE, ikeextstatistics : *mut IKEEXT_STATISTICS0) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IkeextGetStatistics1(enginehandle : FWPM_ENGINE_HANDLE, ikeextstatistics : *mut IKEEXT_STATISTICS1) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn IkeextSaCreateEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumtemplate : *const IKEEXT_SA_ENUM_TEMPLATE0, enumhandle : *mut IKEEXT_SA_ENUM_HANDLE) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn IkeextSaDbGetSecurityInfo0(enginehandle : FWPM_ENGINE_HANDLE, securityinfo : u32, sidowner : *mut super::super::Security:: PSID, sidgroup : *mut super::super::Security:: PSID, dacl : *mut *mut super::super::Security:: ACL, sacl : *mut *mut super::super::Security:: ACL, securitydescriptor : *mut super::super::Security:: PSECURITY_DESCRIPTOR) -> u32);
#[cfg(feature = "Win32_Security")]
windows_targets::link!("fwpuclnt.dll" "system" fn IkeextSaDbSetSecurityInfo0(enginehandle : FWPM_ENGINE_HANDLE, securityinfo : u32, sidowner : *const super::super::Security:: SID, sidgroup : *const super::super::Security:: SID, dacl : *const super::super::Security:: ACL, sacl : *const super::super::Security:: ACL) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IkeextSaDeleteById0(enginehandle : FWPM_ENGINE_HANDLE, id : u64) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IkeextSaDestroyEnumHandle0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : IKEEXT_SA_ENUM_HANDLE) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IkeextSaEnum0(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : IKEEXT_SA_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut IKEEXT_SA_DETAILS0, numentriesreturned : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IkeextSaEnum1(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : IKEEXT_SA_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut IKEEXT_SA_DETAILS1, numentriesreturned : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IkeextSaEnum2(enginehandle : FWPM_ENGINE_HANDLE, enumhandle : IKEEXT_SA_ENUM_HANDLE, numentriesrequested : u32, entries : *mut *mut *mut IKEEXT_SA_DETAILS2, numentriesreturned : *mut u32) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IkeextSaGetById0(enginehandle : FWPM_ENGINE_HANDLE, id : u64, sa : *mut *mut IKEEXT_SA_DETAILS0) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IkeextSaGetById1(enginehandle : FWPM_ENGINE_HANDLE, id : u64, salookupcontext : *const windows_sys::core::GUID, sa : *mut *mut IKEEXT_SA_DETAILS1) -> u32);
windows_targets::link!("fwpuclnt.dll" "system" fn IkeextSaGetById2(enginehandle : FWPM_ENGINE_HANDLE, id : u64, salookupcontext : *const windows_sys::core::GUID, sa : *mut *mut IKEEXT_SA_DETAILS2) -> u32);
