...
pub const CHUNK_IMAGE: CHUNKSTATE = 8i32;
...
pub const FILTER_PIXELFORMAT_BGR8: IMAGE_PIXELFORMAT = 2i32;
pub const FILTER_PIXELFORMAT_BGRA8: IMAGE_PIXELFORMAT = 0i32;
pub const FILTER_PIXELFORMAT_PBGRA8: IMAGE_PIXELFORMAT = 1i32;
