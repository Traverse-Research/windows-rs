...
pub const SDDL_OPENSSH_USERS: windows_sys::core::PCWSTR = windows_sys::core::w!("SH");
...
pub const SDDL_USER_MODE_HARDWARE_OPERATORS: windows_sys::core::PCWSTR = windows_sys::core::w!("HO");
