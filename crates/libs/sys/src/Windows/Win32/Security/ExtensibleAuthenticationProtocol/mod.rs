...
windows_targets::link!("eappprxy.dll" "system" fn EapHostPeerClearConnection(pconnectionid : *const windows_sys::core::GUID, ppeaperror : *mut *mut EAP_ERROR) -> u32);
windows_targets::link!("eappprxy.dll" "system" fn EapHostPeerEndSession(sessionhandle : u32, ppeaperror : *mut *mut EAP_ERROR) -> u32);
windows_targets::link!("eappprxy.dll" "system" fn EapHostPeerFreeEapError(peaperror : *const EAP_ERROR));
...
windows_targets::link!("eappprxy.dll" "system" fn EapHostPeerFreeRuntimeMemory(pdata : *const u8));
