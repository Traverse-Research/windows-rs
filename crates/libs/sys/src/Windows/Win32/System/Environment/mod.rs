...
windows_targets::link!("vertdll.dll" "system" fn EnclaveCopyIntoEnclave(enclaveaddress : *mut core::ffi::c_void, unsecureaddress : *const core::ffi::c_void, numberofbytes : usize) -> windows_sys::core::HRESULT);
windows_targets::link!("vertdll.dll" "system" fn EnclaveCopyOutOfEnclave(unsecureaddress : *mut core::ffi::c_void, enclaveaddress : *const core::ffi::c_void, numberofbytes : usize) -> windows_sys::core::HRESULT);
windows_targets::link!("vertdll.dll" "system" fn EnclaveEncryptDataForTrustlet(datatoencrypt : *const core::ffi::c_void, datatoencryptsize : u32, trustletbindingdata : *const TRUSTLET_BINDING_DATA, encrypteddata : *mut core::ffi::c_void, buffersize : u32, encrypteddatasize : *mut u32) -> windows_sys::core::HRESULT);
...
windows_targets::link!("vertdll.dll" "system" fn EnclaveRestrictContainingProcessAccess(restrictaccess : windows_sys::core::BOOL, previouslyrestricted : *mut windows_sys::core::BOOL) -> windows_sys::core::HRESULT);
...
windows_targets::link!("vertdll.dll" "system" fn EnclaveUsesAttestedKeys() -> bool);
