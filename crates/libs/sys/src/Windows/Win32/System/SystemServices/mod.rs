...
pub const ENERGY_SAVER_HIGH_SAVINGS: ENERGY_SAVER_STATUS = 2i32;
pub const ENERGY_SAVER_OFF: ENERGY_SAVER_STATUS = 0i32;
pub const ENERGY_SAVER_STANDARD: ENERGY_SAVER_STATUS = 1i32;
...
pub const ImagePolicyIdCapabilityOverridable: IMAGE_POLICY_ID = 12i32;
...
pub const ImagePolicyIdMaximum: IMAGE_POLICY_ID = 14i32;
...
pub const ImagePolicyIdTrustletIdOverridable: IMAGE_POLICY_ID = 13i32;
#[repr(C)]
#[derive(Clone, Copy, Default)]
...
pub const PowerLimitBurst: POWER_LIMIT_TYPES = 1i32;
pub const PowerLimitContinuous: POWER_LIMIT_TYPES = 0i32;
