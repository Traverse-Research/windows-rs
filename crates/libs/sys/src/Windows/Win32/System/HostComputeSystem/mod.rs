...
windows_targets::link!("computestorage.dll" "system" fn HcsAttachOverlayFilter(volumemountpoint : windows_sys::core::PCWSTR, layerdata : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
...
windows_targets::link!("computestorage.dll" "system" fn HcsDetachOverlayFilter(volumemountpoint : windows_sys::core::PCWSTR, layerdata : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
...
windows_targets::link!("computecore.dll" "system" fn HcsFinalizeLiveMigration(computesystem : HCS_SYSTEM, operation : HCS_OPERATION, options : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
...
windows_targets::link!("computecore.dll" "system" fn HcsGetOperationProperties(operation : HCS_OPERATION, options : windows_sys::core::PCWSTR, resultdocument : *mut windows_sys::core::PWSTR) -> windows_sys::core::HRESULT);
...
windows_targets::link!("computecore.dll" "system" fn HcsInitializeLiveMigrationOnSource(computesystem : HCS_SYSTEM, operation : HCS_OPERATION, options : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
...
windows_targets::link!("computecore.dll" "system" fn HcsStartLiveMigrationOnSource(computesystem : HCS_SYSTEM, operation : HCS_OPERATION, options : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
windows_targets::link!("computecore.dll" "system" fn HcsStartLiveMigrationTransfer(computesystem : HCS_SYSTEM, operation : HCS_OPERATION, options : windows_sys::core::PCWSTR) -> windows_sys::core::HRESULT);
