...
windows_targets::link!("kernel32.dll" "system" fn AllocConsoleWithOptions(options : *const ALLOC_CONSOLE_OPTIONS, result : *mut ALLOC_CONSOLE_RESULT) -> windows_sys::core::HRESULT);
windows_targets::link!("kernel32.dll" "system" fn AttachConsole(dwprocessid : u32) -> windows_sys::core::BOOL);
windows_targets::link!("kernel32.dll" "system" fn CloseConsoleHandle(hconsole : super::super::Foundation:: HANDLE) -> windows_sys::core::BOOL);
...
windows_targets::link!("kernel32.dll" "system" fn ConsoleMenuControl(hconsoleoutput : super::super::Foundation:: HANDLE, dwcommandidlow : u32, dwcommandidhigh : u32) -> super::super::UI::WindowsAndMessaging:: HMENU);
...
windows_targets::link!("kernel32.dll" "system" fn DuplicateConsoleHandle(hsourcehandle : super::super::Foundation:: HANDLE, dwdesiredaccess : u32, binherithandle : windows_sys::core::BOOL, dwoptions : u32) -> super::super::Foundation:: HANDLE);
...
windows_targets::link!("kernel32.dll" "system" fn GetConsoleCharType(hconsole : super::super::Foundation:: HANDLE, coordcheck : COORD, pdwtype : *mut u32) -> windows_sys::core::BOOL);
...
windows_targets::link!("kernel32.dll" "system" fn GetConsoleCursorMode(hconsolehandle : super::super::Foundation:: HANDLE, pbblink : *mut windows_sys::core::BOOL, pbdbenable : *mut windows_sys::core::BOOL) -> windows_sys::core::BOOL);
windows_targets::link!("kernel32.dll" "system" fn GetConsoleDisplayMode(lpmodeflags : *mut u32) -> windows_sys::core::BOOL);
windows_targets::link!("kernel32.dll" "system" fn GetConsoleFontInfo(hconsoleoutput : super::super::Foundation:: HANDLE, bmaximumwindow : windows_sys::core::BOOL, nlength : u32, lpconsolefontinfo : *mut CONSOLE_FONT_INFO) -> u32);
...
windows_targets::link!("kernel32.dll" "system" fn GetConsoleHardwareState(hconsoleoutput : super::super::Foundation:: HANDLE, lpresolution : *mut COORD, lpfontsize : *mut COORD) -> windows_sys::core::BOOL);
...
windows_targets::link!("kernel32.dll" "system" fn GetConsoleInputExeNameA(nbufferlength : u32, lpbuffer : windows_sys::core::PSTR) -> u32);
windows_targets::link!("kernel32.dll" "system" fn GetConsoleInputExeNameW(nbufferlength : u32, lpbuffer : windows_sys::core::PWSTR) -> u32);
windows_targets::link!("kernel32.dll" "system" fn GetConsoleInputWaitHandle() -> super::super::Foundation:: HANDLE);
windows_targets::link!("user32.dll" "system" fn GetConsoleKeyboardLayoutNameA(pszlayout : windows_sys::core::PSTR) -> windows_sys::core::BOOL);
windows_targets::link!("user32.dll" "system" fn GetConsoleKeyboardLayoutNameW(pszlayout : windows_sys::core::PWSTR) -> windows_sys::core::BOOL);
...
windows_targets::link!("kernel32.dll" "system" fn GetConsoleNlsMode(hconsole : super::super::Foundation:: HANDLE, lpdwnlsmode : *mut u32) -> windows_sys::core::BOOL);
...
windows_targets::link!("kernel32.dll" "system" fn GetNumberOfConsoleFonts() -> u32);
...
windows_targets::link!("kernel32.dll" "system" fn InvalidateConsoleDIBits(hconsoleoutput : super::super::Foundation:: HANDLE, lprect : *const SMALL_RECT) -> windows_sys::core::BOOL);
windows_targets::link!("kernel32.dll" "system" fn OpenConsoleW(lpconsoledevice : windows_sys::core::PCWSTR, dwdesiredaccess : u32, binherithandle : windows_sys::core::BOOL, dwsharemode : u32) -> super::super::Foundation:: HANDLE);
...
windows_targets::link!("kernel32.dll" "system" fn ReadConsoleInputExA(hconsoleinput : super::super::Foundation:: HANDLE, lpbuffer : *mut INPUT_RECORD, nlength : u32, lpnumberofeventsread : *mut u32, wflags : u16) -> windows_sys::core::BOOL);
windows_targets::link!("kernel32.dll" "system" fn ReadConsoleInputExW(hconsoleinput : super::super::Foundation:: HANDLE, lpbuffer : *mut INPUT_RECORD, nlength : u32, lpnumberofeventsread : *mut u32, wflags : u16) -> windows_sys::core::BOOL);
...
windows_targets::link!("kernel32.dll" "system" fn RegisterConsoleIME(hwndconsoleime : super::super::Foundation:: HWND, lpdwconsolethreadid : *mut u32) -> windows_sys::core::BOOL);
windows_targets::link!("kernel32.dll" "system" fn RegisterConsoleOS2(fos2register : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
windows_targets::link!("kernel32.dll" "system" fn RegisterConsoleVDM(dwregisterflags : u32, hstarthardwareevent : super::super::Foundation:: HANDLE, hendhardwareevent : super::super::Foundation:: HANDLE, herrorhardwareevent : super::super::Foundation:: HANDLE, reserved : u32, lpstatelength : *mut u32, lpstate : *mut *mut core::ffi::c_void, vdmbuffersize : COORD, lpvdmbuffer : *mut *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_targets::link!("kernel32.dll" "system" fn ReleasePseudoConsole(hpc : HPCON) -> windows_sys::core::HRESULT);
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
windows_targets::link!("kernel32.dll" "system" fn SetConsoleCursor(hconsoleoutput : super::super::Foundation:: HANDLE, hcursor : super::super::UI::WindowsAndMessaging:: HCURSOR) -> windows_sys::core::BOOL);
...
windows_targets::link!("kernel32.dll" "system" fn SetConsoleCursorMode(hconsolehandle : super::super::Foundation:: HANDLE, blink : windows_sys::core::BOOL, dbenable : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
...
windows_targets::link!("kernel32.dll" "system" fn SetConsoleFont(hconsoleoutput : super::super::Foundation:: HANDLE, nfont : u32) -> windows_sys::core::BOOL);
windows_targets::link!("kernel32.dll" "system" fn SetConsoleHardwareState(hconsoleoutput : super::super::Foundation:: HANDLE, dwresolution : COORD, dwfontsize : COORD) -> windows_sys::core::BOOL);
...
#[cfg(feature = "Win32_UI_WindowsAndMessaging")]
windows_targets::link!("kernel32.dll" "system" fn SetConsoleIcon(hicon : super::super::UI::WindowsAndMessaging:: HICON) -> windows_sys::core::BOOL);
windows_targets::link!("kernel32.dll" "system" fn SetConsoleInputExeNameA(lpexename : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
windows_targets::link!("kernel32.dll" "system" fn SetConsoleInputExeNameW(lpexename : windows_sys::core::PCWSTR) -> windows_sys::core::BOOL);
windows_targets::link!("kernel32.dll" "system" fn SetConsoleKeyShortcuts(bset : windows_sys::core::BOOL, breservekeys : u8, lpappkeys : *const APPKEY, dwnumappkeys : u32) -> windows_sys::core::BOOL);
windows_targets::link!("kernel32.dll" "system" fn SetConsoleLocalEUDC(hconsolehandle : super::super::Foundation:: HANDLE, wcodepoint : u16, cfontsize : COORD, lpsb : windows_sys::core::PCSTR) -> windows_sys::core::BOOL);
windows_targets::link!("kernel32.dll" "system" fn SetConsoleMenuClose(benable : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
...
windows_targets::link!("kernel32.dll" "system" fn SetConsoleNlsMode(hconsole : super::super::Foundation:: HANDLE, fdwnlsmode : u32) -> windows_sys::core::BOOL);
...
windows_targets::link!("kernel32.dll" "system" fn SetConsoleOS2OemFormat(fos2oemformat : windows_sys::core::BOOL) -> windows_sys::core::BOOL);
windows_targets::link!("kernel32.dll" "system" fn SetConsoleOutputCP(wcodepageid : u32) -> windows_sys::core::BOOL);
#[cfg(feature = "Win32_Graphics_Gdi")]
windows_targets::link!("kernel32.dll" "system" fn SetConsolePalette(hconsoleoutput : super::super::Foundation:: HANDLE, hpalette : super::super::Graphics::Gdi:: HPALETTE, dwusage : u32) -> windows_sys::core::BOOL);
...
windows_targets::link!("kernel32.dll" "system" fn SetLastConsoleEventActive());
...
windows_targets::link!("kernel32.dll" "system" fn ShowConsoleCursor(hconsoleoutput : super::super::Foundation:: HANDLE, bshow : windows_sys::core::BOOL) -> i32);
windows_targets::link!("kernel32.dll" "system" fn UnregisterConsoleIME() -> windows_sys::core::BOOL);
windows_targets::link!("kernel32.dll" "system" fn VDMConsoleOperation(ifunction : u32, lpdata : *mut core::ffi::c_void) -> windows_sys::core::BOOL);
windows_targets::link!("kernel32.dll" "system" fn VerifyConsoleIoHandle(hiohandle : super::super::Foundation:: HANDLE) -> windows_sys::core::BOOL);
...
windows_targets::link!("kernel32.dll" "system" fn WriteConsoleInputVDMA(hconsoleinput : super::super::Foundation:: HANDLE, lpbuffer : *const INPUT_RECORD, nlength : u32, lpnumberofeventswritten : *mut u32) -> windows_sys::core::BOOL);
windows_targets::link!("kernel32.dll" "system" fn WriteConsoleInputVDMW(hconsoleinput : super::super::Foundation:: HANDLE, lpbuffer : *const INPUT_RECORD, nlength : u32, lpnumberofeventswritten : *mut u32) -> windows_sys::core::BOOL);
