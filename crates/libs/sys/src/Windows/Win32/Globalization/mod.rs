...
windows_link::link!("icu.dll" "C" fn unumf_resultToDecimalNumber(uresult : *const UFormattedNumber, dest : windows_sys::core::PCSTR, destcapacity : i32, ec : *mut UErrorCode) -> i32);
...
windows_link::link!("icu.dll" "C" fn unumrf_formatDecimalRange(uformatter : *const UNumberRangeFormatter, first : windows_sys::core::PCSTR, firstlen : i32, second : windows_sys::core::PCSTR, secondlen : i32, uresult : *mut UFormattedNumberRange, ec : *mut UErrorCode));
...
windows_link::link!("icu.dll" "C" fn unumrf_openForSkeletonWithCollapseAndIdentityFallback(skeleton : *const u16, skeletonlen : i32, collapse : UNumberRangeCollapse, identityfallback : UNumberRangeIdentityFallback, locale : windows_sys::core::PCSTR, perror : *mut UParseError, ec : *mut UErrorCode) -> *mut UNumberRangeFormatter);
...
windows_link::link!("icu.dll" "C" fn unumrf_resultGetFirstDecimalNumber(uresult : *const UFormattedNumberRange, dest : windows_sys::core::PCSTR, destcapacity : i32, ec : *mut UErrorCode) -> i32);
...
windows_link::link!("icu.dll" "C" fn unumrf_resultGetSecondDecimalNumber(uresult : *const UFormattedNumberRange, dest : windows_sys::core::PCSTR, destcapacity : i32, ec : *mut UErrorCode) -> i32);
