...
windows_targets::link!("icu.dll" "C" fn u_stringHasBinaryProperty(s : *const u16, length : i32, which : UProperty) -> i8);
...
windows_targets::link!("icu.dll" "C" fn ubrk_clone(bi : *const UBreakIterator, status : *mut UErrorCode) -> *mut UBreakIterator);
...
windows_targets::link!("icu.dll" "C" fn ucal_getTimeZoneOffsetFromLocal(cal : *const *const core::ffi::c_void, nonexistingtimeopt : UTimeZoneLocalOption, duplicatedtimeopt : UTimeZoneLocalOption, rawoffset : *mut i32, dstoffset : *mut i32, status : *mut UErrorCode));
...
windows_targets::link!("icu.dll" "C" fn ucnv_clone(cnv : *const UConverter, status : *mut UErrorCode) -> *mut UConverter);
...
windows_targets::link!("icu.dll" "C" fn ucol_clone(coll : *const UCollator, status : *mut UErrorCode) -> *mut UCollator);
...
windows_targets::link!("icu.dll" "C" fn udatpg_getDefaultHourCycle(dtpg : *const *const core::ffi::c_void, perrorcode : *mut UErrorCode) -> UDateFormatHourCycle);
...
windows_targets::link!("icu.dll" "C" fn udtitvfmt_formatToResult(formatter : *const UDateIntervalFormat, fromdate : f64, todate : f64, result : *mut UFormattedDateInterval, status : *mut UErrorCode));
windows_targets::link!("icu.dll" "C" fn udtitvfmt_getContext(formatter : *const UDateIntervalFormat, r#type : UDisplayContextType, status : *mut UErrorCode) -> UDisplayContext);
...
windows_targets::link!("icu.dll" "C" fn udtitvfmt_setContext(formatter : *mut UDateIntervalFormat, value : UDisplayContext, status : *mut UErrorCode));
...
windows_targets::link!("icu.dll" "C" fn unumf_resultToDecimalNumber(uresult : *const UFormattedNumber, dest : windows_sys::core::PCSTR, destcapacity : i32, ec : *mut UErrorCode) -> i32);
...
windows_targets::link!("icu.dll" "C" fn unumrf_close(uformatter : *mut UNumberRangeFormatter));
windows_targets::link!("icu.dll" "C" fn unumrf_closeResult(uresult : *mut UFormattedNumberRange));
windows_targets::link!("icu.dll" "C" fn unumrf_formatDecimalRange(uformatter : *const UNumberRangeFormatter, first : windows_sys::core::PCSTR, firstlen : i32, second : windows_sys::core::PCSTR, secondlen : i32, uresult : *mut UFormattedNumberRange, ec : *mut UErrorCode));
windows_targets::link!("icu.dll" "C" fn unumrf_formatDoubleRange(uformatter : *const UNumberRangeFormatter, first : f64, second : f64, uresult : *mut UFormattedNumberRange, ec : *mut UErrorCode));
windows_targets::link!("icu.dll" "C" fn unumrf_openForSkeletonWithCollapseAndIdentityFallback(skeleton : *const u16, skeletonlen : i32, collapse : UNumberRangeCollapse, identityfallback : UNumberRangeIdentityFallback, locale : windows_sys::core::PCSTR, perror : *mut UParseError, ec : *mut UErrorCode) -> *mut UNumberRangeFormatter);
windows_targets::link!("icu.dll" "C" fn unumrf_openResult(ec : *mut UErrorCode) -> *mut UFormattedNumberRange);
windows_targets::link!("icu.dll" "C" fn unumrf_resultAsValue(uresult : *const UFormattedNumberRange, ec : *mut UErrorCode) -> *mut UFormattedValue);
windows_targets::link!("icu.dll" "C" fn unumrf_resultGetFirstDecimalNumber(uresult : *const UFormattedNumberRange, dest : windows_sys::core::PCSTR, destcapacity : i32, ec : *mut UErrorCode) -> i32);
windows_targets::link!("icu.dll" "C" fn unumrf_resultGetIdentityResult(uresult : *const UFormattedNumberRange, ec : *mut UErrorCode) -> UNumberRangeIdentityResult);
windows_targets::link!("icu.dll" "C" fn unumrf_resultGetSecondDecimalNumber(uresult : *const UFormattedNumberRange, dest : windows_sys::core::PCSTR, destcapacity : i32, ec : *mut UErrorCode) -> i32);
...
windows_targets::link!("icu.dll" "C" fn uset_complementAllCodePoints(set : *mut USet, str : *const u16, length : i32));
windows_targets::link!("icu.dll" "C" fn uset_complementRange(set : *mut USet, start : i32, end : i32));
windows_targets::link!("icu.dll" "C" fn uset_complementString(set : *mut USet, str : *const u16, length : i32));
...
windows_targets::link!("icu.dll" "C" fn uset_getRangeCount(set : *const USet) -> i32);
...
windows_targets::link!("icu.dll" "C" fn uset_hasStrings(set : *const USet) -> i8);
...
windows_targets::link!("icu.dll" "C" fn uset_removeAllCodePoints(set : *mut USet, str : *const u16, length : i32));
...
windows_targets::link!("icu.dll" "C" fn uset_retainAllCodePoints(set : *mut USet, str : *const u16, length : i32));
windows_targets::link!("icu.dll" "C" fn uset_retainString(set : *mut USet, str : *const u16, length : i32));
...
pub const UCAL_TZ_LOCAL_DAYLIGHT_FORMER: UTimeZoneLocalOption = 7i32;
pub const UCAL_TZ_LOCAL_DAYLIGHT_LATTER: UTimeZoneLocalOption = 15i32;
pub const UCAL_TZ_LOCAL_FORMER: UTimeZoneLocalOption = 4i32;
pub const UCAL_TZ_LOCAL_LATTER: UTimeZoneLocalOption = 12i32;
pub const UCAL_TZ_LOCAL_STANDARD_FORMER: UTimeZoneLocalOption = 5i32;
pub const UCAL_TZ_LOCAL_STANDARD_LATTER: UTimeZoneLocalOption = 13i32;
...
pub const UCURR_VARIANT_SYMBOL_NAME: UCurrNameStyle = 3i32;
...
pub const UDAT_HOUR_CYCLE_11: UDateFormatHourCycle = 0i32;
pub const UDAT_HOUR_CYCLE_12: UDateFormatHourCycle = 1i32;
pub const UDAT_HOUR_CYCLE_23: UDateFormatHourCycle = 2i32;
pub const UDAT_HOUR_CYCLE_24: UDateFormatHourCycle = 3i32;
...
pub const UDAT_NARROW_QUARTERS: UDateFormatSymbolType = 28i32;
...
pub const UDAT_STANDALONE_NARROW_QUARTERS: UDateFormatSymbolType = 29i32;
...
pub const UFIELD_CATEGORY_NUMBER_RANGE_SPAN: UFieldCategory = 4098i32;
...
pub const UNUM_MINIMUM_GROUPING_DIGITS_AUTO: UNumberFormatMinimumGroupingDigits = -2i32;
pub const UNUM_MINIMUM_GROUPING_DIGITS_MIN2: UNumberFormatMinimumGroupingDigits = -3i32;
...
pub const UNUM_ROUND_HALF_CEILING: UNumberFormatRoundingMode = 9i32;
pub const UNUM_ROUND_HALF_FLOOR: UNumberFormatRoundingMode = 10i32;
pub const UNUM_ROUND_HALF_ODD: UNumberFormatRoundingMode = 8i32;
...
pub const UNUM_SIGN_ACCOUNTING_NEGATIVE: UNumberSignDisplay = 8i32;
...
pub const UNUM_TRAILING_ZERO_AUTO: UNumberTrailingZeroDisplay = 0i32;
pub const UNUM_TRAILING_ZERO_HIDE_IF_WHOLE: UNumberTrailingZeroDisplay = 1i32;
pub const UNUM_TWO_DIGIT_SYMBOL: UNumberFormatSymbol = 19i32;
pub const UNUM_UNIT_WIDTH_COUNT: UNumberUnitWidth = 7i32;
pub const UNUM_UNIT_WIDTH_FORMAL: UNumberUnitWidth = 4i32;
pub const UNUM_UNIT_WIDTH_FULL_NAME: UNumberUnitWidth = 2i32;
pub const UNUM_UNIT_WIDTH_HIDDEN: UNumberUnitWidth = 6i32;
...
pub const UNUM_UNIT_WIDTH_VARIANT: UNumberUnitWidth = 5i32;
...
pub type UNumberRangeFormatter = isize;
...
pub const U_INPUT_TOO_LONG_ERROR: UErrorCode = 31i32;
...
pub const U_JG_THIN_YEH: UJoiningGroup = 102i32;
pub const U_JG_VERTICAL_TAIL: UJoiningGroup = 103i32;
